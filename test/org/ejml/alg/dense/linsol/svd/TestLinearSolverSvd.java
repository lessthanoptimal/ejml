 ...
 * @author Peter Abeles
 */
public class TestLinearSolverSvd extends GenericLinearSolverChecks {

    public TestLinearSolverSvd() {
    ...
    protected LinearSolver createSolver(int numRows, int numCols) {
        SvdNumericalRecipes decomp = new SvdNumericalRecipes();

        return new LinearSolverSvdNR(decomp);
    }
}
