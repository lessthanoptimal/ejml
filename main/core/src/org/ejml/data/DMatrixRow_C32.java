 ...
 * @author Peter Abeles
 */
public class DMatrixRow_C32 extends D1Matrix_C32 {
     ...
     */
    public DMatrixRow_C32(float data[][] ) {
    ...
    public DMatrixRow_C32(int numRows, int numCols, boolean rowMajor, float... data) {
    ...
    /**
     * Creates a new {@link DMatrixRow_C32} which is a copy of the passed in matrix.
     * @param original Matrix which is to be copied
     */
    public DMatrixRow_C32(DMatrixRow_C32 original) {
     ...
     */
    public DMatrixRow_C32(int numRows, int numCols) {
        this.numRows = numRows;
        this.numCols = numCols;
        this.data = new float[numRows*numCols*2];
    }
    ...
    public void set( DMatrixRow_C32 original ) {
    ...
    @Override
    public DMatrixRow_C32 copy() {
        return new DMatrixRow_C32(this);
    }
    ...
    public void set(Matrix original) {
        ...
        Matrix_C32 n = (Matrix_C32)original;
    ...
    public <T extends Matrix> T createLike() {
        return (T)new DMatrixRow_C32(numRows,numCols);
    }
}
