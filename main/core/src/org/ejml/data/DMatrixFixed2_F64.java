 ...
 * @author Peter Abeles
 */
public class DMatrixFixed2_F64 implements DMatrixFixed_F64 {
    public double a1,a2;

    public DMatrixFixed2_F64() {
    }

    public DMatrixFixed2_F64(double a1, double a2)
    {
        this.a1 = a1;
        this.a2 = a2;
    }

    public DMatrixFixed2_F64(DMatrixFixed2_F64 o) {
        this.a1 = o.a1;
        this.a2 = o.a2;
    }
    ...
    public <T extends Matrix> T copy() {
        return (T)new DMatrixFixed2_F64(this);
    }
    ...
    public <T extends Matrix> T createLike() {
        return (T)new DMatrixFixed2_F64();
    }
}
