...
/**
 * <p>
 * Describes a rectangular submatrix inside of a {@link D1Matrix_F64}.
 * </p>
 *
 * <p>
 ...
 * @author Peter Abeles
 */
public class D1Submatrix_F64 {
    public D1Matrix_F64 original;

    // bounding rows and columns
    public int row0,col0;
    public int row1,col1;

    public D1Submatrix_F64() {
    }

    public D1Submatrix_F64(D1Matrix_F64 original) {
        set(original);
    }
    ...
    public void set(D1Matrix_F64 original,
                    int row0, int row1, int col0, int col1) {
