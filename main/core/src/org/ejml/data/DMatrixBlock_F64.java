 ...
 * @author Peter Abeles
 */
public class DMatrixBlock_F64 extends D1Matrix_F64 {
    public int blockLength;

    public DMatrixBlock_F64(int numRows , int numCols , int blockLength)
    {
    ...
    public DMatrixBlock_F64(int numRows , int numCols )
    {
        this(numRows,numCols, EjmlParameters.BLOCK_WIDTH);
    }

    public DMatrixBlock_F64(){}

    public void set( DMatrixBlock_F64 A ) {
    ...
    public static DMatrixBlock_F64 wrap(double data[] , int numRows , int numCols , int blockLength )
    {
        DMatrixBlock_F64 ret = new DMatrixBlock_F64();
        ret.data = data;
        ret.numRows = numRows;
        ret.numCols = numCols;
    ...
    public <T extends Matrix> T createLike() {
        return (T)new DMatrixBlock_F64(numRows,numCols);
    }
