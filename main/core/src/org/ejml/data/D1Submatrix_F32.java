...
/**
 * <p>
 * Describes a rectangular submatrix inside of a {@link D1Matrix_F32}.
 * </p>
 *
 * <p>
 ...
 * @author Peter Abeles
 */
public class D1Submatrix_F32 {
    public D1Matrix_F32 original;

    // bounding rows and columns
    public int row0,col0;
    public int row1,col1;

    public D1Submatrix_F32() {
    }

    public D1Submatrix_F32(D1Matrix_F32 original) {
        set(original);
    }
    ...
    public void set(D1Matrix_F32 original,
                    int row0, int row1, int col0, int col1) {
