 ...
 * @author Peter Abeles
 */
public class RowMatrix_C64 extends D1Matrix_C64 {
     ...
     */
    public RowMatrix_C64(double data[][] ) {
    ...
    public RowMatrix_C64(int numRows, int numCols, boolean rowMajor, double... data) {
    ...
    /**
     * Creates a new {@link RowMatrix_C64} which is a copy of the passed in matrix.
     * @param original Matrix which is to be copied
     */
    public RowMatrix_C64(RowMatrix_C64 original) {
     ...
     */
    public RowMatrix_C64(int numRows, int numCols) {
        this.numRows = numRows;
        this.numCols = numCols;
        this.data = new double[numRows*numCols*2];
    }
    ...
    public void set( RowMatrix_C64 original ) {
    ...
    @Override
    public RowMatrix_C64 copy() {
        return new RowMatrix_C64(this);
    }
    ...
    public <T extends Matrix> T createLike() {
        return (T)new RowMatrix_C64(numRows,numCols);
    }
}
