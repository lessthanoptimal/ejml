 ...
 * @author Peter Abeles
 */
public class DMatrixRow_B implements ReshapeMatrix {
    /**
    ...
    public DMatrixRow_B(int numRows , int numCols ) {
    ...
    public <T extends Matrix> T copy() {
        DMatrixRow_B ret = new DMatrixRow_B(numRows,numCols);
        ret.set(this);
        return (T)ret;
    }
    ...
    public void set(Matrix original) {
        DMatrixRow_B orig = (DMatrixRow_B)original;
    ...
    public <T extends Matrix> T createLike() {
        return (T)new DMatrixRow_B(numRows,numCols);
    }
}
