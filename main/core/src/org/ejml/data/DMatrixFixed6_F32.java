 ...
 * @author Peter Abeles
 */
public class DMatrixFixed6_F32 implements DMatrixFixed_F32 {
    public float a1,a2,a3,a4,a5,a6;

    public DMatrixFixed6_F32() {
    }

    public DMatrixFixed6_F32(float a1, float a2, float a3, float a4, float a5, float a6)
    {
        this.a1 = a1;
        this.a2 = a2;
        this.a3 = a3;
    ...
    public DMatrixFixed6_F32(DMatrixFixed6_F32 o) {
        this.a1 = o.a1;
        this.a2 = o.a2;
        this.a3 = o.a3;
        this.a4 = o.a4;
    ...
    public <T extends Matrix> T copy() {
        return (T)new DMatrixFixed6_F32(this);
    }
    ...
    public <T extends Matrix> T createLike() {
        return (T)new DMatrixFixed6_F32();
    }
}
