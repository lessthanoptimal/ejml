 ...
 * @author Peter Abeles
 */
public class DMatrixRow_C64 extends D1Matrix_C64 {
     ...
     */
    public DMatrixRow_C64(double data[][] ) {
    ...
    public DMatrixRow_C64(int numRows, int numCols, boolean rowMajor, double... data) {
    ...
    /**
     * Creates a new {@link DMatrixRow_C64} which is a copy of the passed in matrix.
     * @param original Matrix which is to be copied
     */
    public DMatrixRow_C64(DMatrixRow_C64 original) {
     ...
     */
    public DMatrixRow_C64(int numRows, int numCols) {
        this.numRows = numRows;
        this.numCols = numCols;
        this.data = new double[numRows*numCols*2];
    }
    ...
    public void set( DMatrixRow_C64 original ) {
    ...
    @Override
    public DMatrixRow_C64 copy() {
        return new DMatrixRow_C64(this);
    }
    ...
    public void set(Matrix original) {
        ...
        Matrix_C64 n = (Matrix_C64)original;
    ...
    public <T extends Matrix> T createLike() {
        return (T)new DMatrixRow_C64(numRows,numCols);
    }
}
