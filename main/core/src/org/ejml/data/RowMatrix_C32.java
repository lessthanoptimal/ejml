 ...
 * @author Peter Abeles
 */
public class RowMatrix_C32 extends D1Matrix_C32 {
     ...
     */
    public RowMatrix_C32(float data[][] ) {
    ...
    public RowMatrix_C32(int numRows, int numCols, boolean rowMajor, float... data) {
    ...
    /**
     * Creates a new {@link RowMatrix_C32} which is a copy of the passed in matrix.
     * @param original Matrix which is to be copied
     */
    public RowMatrix_C32(RowMatrix_C32 original) {
     ...
     */
    public RowMatrix_C32(int numRows, int numCols) {
        this.numRows = numRows;
        this.numCols = numCols;
        this.data = new float[numRows*numCols*2];
    }
    ...
    public void set( RowMatrix_C32 original ) {
    ...
    @Override
    public RowMatrix_C32 copy() {
        return new RowMatrix_C32(this);
    }
    ...
    public <T extends Matrix> T createLike() {
        return (T)new RowMatrix_C32(numRows,numCols);
    }
}
