 ...
 * @author Peter Abeles
 */
public class DMatrixFixed2_F32 implements DMatrixFixed_F32 {
    public float a1,a2;

    public DMatrixFixed2_F32() {
    }

    public DMatrixFixed2_F32(float a1, float a2)
    {
        this.a1 = a1;
        this.a2 = a2;
    }

    public DMatrixFixed2_F32(DMatrixFixed2_F32 o) {
        this.a1 = o.a1;
        this.a2 = o.a2;
    }
    ...
    public <T extends Matrix> T copy() {
        return (T)new DMatrixFixed2_F32(this);
    }
    ...
    public <T extends Matrix> T createLike() {
        return (T)new DMatrixFixed2_F32();
    }
}
