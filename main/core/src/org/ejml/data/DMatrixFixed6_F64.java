 ...
 * @author Peter Abeles
 */
public class DMatrixFixed6_F64 implements DMatrixFixed_F64 {
    public double a1,a2,a3,a4,a5,a6;

    public DMatrixFixed6_F64() {
    }

    public DMatrixFixed6_F64(double a1, double a2, double a3, double a4, double a5, double a6)
    {
        this.a1 = a1;
        this.a2 = a2;
        this.a3 = a3;
    ...
    public DMatrixFixed6_F64(DMatrixFixed6_F64 o) {
        this.a1 = o.a1;
        this.a2 = o.a2;
        this.a3 = o.a3;
        this.a4 = o.a4;
    ...
    public <T extends Matrix> T copy() {
        return (T)new DMatrixFixed6_F64(this);
    }
    ...
    public <T extends Matrix> T createLike() {
        return (T)new DMatrixFixed6_F64();
    }
}
