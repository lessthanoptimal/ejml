 ...
 * @author Peter Abeles
 */
public class RowMatrix_B implements ReshapeMatrix {
    /**
    ...
    public RowMatrix_B(int numRows , int numCols ) {
    ...
    public <T extends Matrix> T copy() {
        RowMatrix_B ret = new RowMatrix_B(numRows,numCols);
        ret.set(this);
        return (T)ret;
    }
    ...
    public void set(Matrix original) {
        RowMatrix_B orig = (RowMatrix_B)original;
    ...
    public <T extends Matrix> T createLike() {
        return (T)new RowMatrix_B(numRows,numCols);
    }
}
