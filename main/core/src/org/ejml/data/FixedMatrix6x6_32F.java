...
/**
 * Fixed sized 6 by FixedMatrix6x6_32F matrix.  The matrix is stored as class variables for very fast read/write.  aXY is the
 * value of row = X and column = Y.
 *
 * @author Peter Abeles
 */
public class FixedMatrix6x6_32F implements FixedMatrix32F {
    ...
    public FixedMatrix6x6_32F() {
    }

    public FixedMatrix6x6_32F( float a11,float a12,float a13,float a14,float a15,float a16,
    ...
    public FixedMatrix6x6_32F( FixedMatrix6x6_32F o ) {
        this.a11 = o.a11;
        this.a12 = o.a12;
        this.a13 = o.a13;
        this.a14 = o.a14;
    ...
    public <T extends Matrix> T copy() {
        return (T)new FixedMatrix6x6_32F(this);
    }
    ...
    public <T extends Matrix> T createLike() {
        return (T)new FixedMatrix6x6_32F();
    }
}
