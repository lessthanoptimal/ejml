 ...
 * @author Peter Abeles
 */
public class BlockMatrix_F32 extends D1Matrix_F32 {
    public int blockLength;

    public BlockMatrix_F32(int numRows , int numCols , int blockLength)
    {
    ...
    public BlockMatrix_F32(int numRows , int numCols )
    {
        this(numRows,numCols, EjmlParameters.BLOCK_WIDTH);
    }

    public BlockMatrix_F32(){}

    public void set( BlockMatrix_F32 A ) {
    ...
    public static BlockMatrix_F32 wrap(float data[] , int numRows , int numCols , int blockLength )
    {
        BlockMatrix_F32 ret = new BlockMatrix_F32();
        ret.data = data;
        ret.numRows = numRows;
        ret.numCols = numCols;
    ...
    public <T extends Matrix> T createLike() {
        return (T)new BlockMatrix_F32(numRows,numCols);
    }

    @Override
    public void set(Matrix original) {
        if( original instanceof BlockMatrix_F32) {
            set((BlockMatrix_F32)original);
        } else {
    ...
    public BlockMatrix_F32 copy() {
        BlockMatrix_F32 A = new BlockMatrix_F32(numRows,numCols,blockLength);
        A.set(this);
        return A;
    }
}
