...
/**
 * <p>
 * Describes a rectangular submatrix inside of a {@link D1Matrix32F}.
 * </p>
 *
 * <p>
 ...
 * @author Peter Abeles
 */
public class D1Submatrix32F {
    public D1Matrix32F original;

    // bounding rows and columns
    public int row0,col0;
    public int row1,col1;

    public D1Submatrix32F() {
    }

    public D1Submatrix32F(D1Matrix32F original) {
        set(original);
    }
    ...
    public void set(D1Matrix32F original,
                    int row0, int row1, int col0, int col1) {
    ...
    public DenseMatrix32F extract() {
        DenseMatrix32F ret = new DenseMatrix32F(row1-row0,col1-col0);
