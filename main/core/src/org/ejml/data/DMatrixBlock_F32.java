 ...
 * @author Peter Abeles
 */
public class DMatrixBlock_F32 extends D1Matrix_F32 {
    public int blockLength;

    public DMatrixBlock_F32(int numRows , int numCols , int blockLength)
    {
    ...
    public DMatrixBlock_F32(int numRows , int numCols )
    {
        this(numRows,numCols, EjmlParameters.BLOCK_WIDTH);
    }

    public DMatrixBlock_F32(){}

    public void set( DMatrixBlock_F32 A ) {
    ...
    public static DMatrixBlock_F32 wrap(float data[] , int numRows , int numCols , int blockLength )
    {
        DMatrixBlock_F32 ret = new DMatrixBlock_F32();
        ret.data = data;
        ret.numRows = numRows;
        ret.numCols = numCols;
    ...
    public <T extends Matrix> T createLike() {
        return (T)new DMatrixBlock_F32(numRows,numCols);
    }
    ...
    public DMatrixBlock_F32 copy() {
        DMatrixBlock_F32 A = new DMatrixBlock_F32(numRows,numCols,blockLength);
        A.set(this);
        return A;
    }
}
