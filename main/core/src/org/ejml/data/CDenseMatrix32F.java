 ...
 * @author Peter Abeles
 */
public class CDenseMatrix32F extends CD1Matrix32F {
     ...
     */
    public CDenseMatrix32F( float data[][] ) {
    ...
    public CDenseMatrix32F(int numRows, int numCols, boolean rowMajor, float... data) {
    ...
    /**
     * Creates a new {@link org.ejml.data.CDenseMatrix32F} which is a copy of the passed in matrix.
     * @param original Matrix which is to be copied
     */
    public CDenseMatrix32F(CDenseMatrix32F original) {
     ...
     */
    public CDenseMatrix32F(int numRows, int numCols) {
        this.numRows = numRows;
        this.numCols = numCols;
        this.data = new float[numRows*numCols*2];
    }
    ...
    @Override
    public void get(int row, int col, Complex32F output) {
    ...
    public void set( CDenseMatrix32F original ) {
    ...
    @Override
    public CDenseMatrix32F copy() {
        return new CDenseMatrix32F(this);
    }
    ...
    public void set(Matrix original) {
        ...
        ComplexMatrix32F n = (ComplexMatrix32F)original;
    ...
    public <T extends Matrix> T createLike() {
        return (T)new CDenseMatrix32F(numRows,numCols);
    }
}
