...
public class ConvertMatrixData {
    public static void convert(DMatrixRow_F64 src, DMatrixRow_F32 dst ) {
    ...
    public static void convert(DMatrixRow_F32 src, DMatrixRow_F64 dst ) {
        int N = src.getNumElements();
        for (int i = 0; i < N; i++) {
    ...
    public static void convert(DMatrixFixed2x2_F64 src, DMatrixFixed2x2_F32 dst ) {
        dst.a11 = (float)src.a11; dst.a12 = (float)src.a12;
        dst.a21 = (float)src.a21; dst.a22 = (float)src.a22;
    }

    public static void convert(DMatrixFixed3x3_F64 src, DMatrixFixed3x3_F32 dst ) {
    ...
    public static void convert(DMatrixFixed4x4_F64 src, DMatrixFixed4x4_F32 dst ) {
    ...
    public static void convert(DMatrixFixed2x2_F32 src, DMatrixFixed2x2_F64 dst ) {
        dst.a11 = src.a11; dst.a12 = src.a12;
        dst.a21 = src.a21; dst.a22 = src.a22;
    }

    public static void convert(DMatrixFixed3x3_F32 src, DMatrixFixed3x3_F64 dst ) {
    ...
    public static void convert(DMatrixFixed4x4_F32 src, DMatrixFixed4x4_F64 dst ) {
