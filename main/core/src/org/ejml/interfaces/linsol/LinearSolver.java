 ...
 * <ol>
 * <li> Call {@link #setA(org.ejml.data.RealMatrix64F)}
 * <li> Call {@link #solve(org.ejml.data.RealMatrix64F, org.ejml.data.RealMatrix64F)}.
 * </ol>
 * </p>
 *
 * <p>
 ...
 * <ol>
 * <li> Call {@link #setA(org.ejml.data.RealMatrix64F)}
 * <li> Call {@link #invert(org.ejml.data.RealMatrix64F)}.
 * </ol>
 ...
 * @author Peter Abeles
 */
public interface LinearSolver< T extends RealMatrix64F> {
    ...
    /**
     * Computes the inverse of of the 'A' matrix passed into {@link #setA(org.ejml.data.RealMatrix64F)}
    ...
    /**
     * Returns true if the passed in matrix to {@link #setA(org.ejml.data.RealMatrix64F)}
     * is modified.
     *
    ...
    /**
     * Returns true if the passed in 'B' matrix to {@link #solve(org.ejml.data.RealMatrix64F, org.ejml.data.RealMatrix64F)}
     * is modified.
     *
