 ...
 * @author Peter Abeles
 */
public class TestDMatrixRow_C32 {

    Random rand = new Random(234);

    @Test
    public void constructor_darray() {
        DMatrixRow_C32 a = new DMatrixRow_C32(new float[][]{{1,2,3,4},{5,6,7,8},{5,6,7,8}});
        DMatrixRow_C32 b = new DMatrixRow_C32(3,2,true,1,2,3,4,5,6,7,8,5,6,7,8);
    ...
    public void constructor_cmatrix() {
        DMatrixRow_C32 a = new DMatrixRow_C32(3,4);
        a.set(1,3,9,2);

        DMatrixRow_C32 b = new DMatrixRow_C32(a);
    ...
    public void constructor_shape() {
        DMatrixRow_C32 a = new DMatrixRow_C32(5,7);
    ...
    public void getDataLength() {
        assertEquals(3*4*2,new DMatrixRow_C32(3,4).getDataLength());
    }
    ...
    public void set_array() {
        DMatrixRow_C32 A = RandomMatrices_CR32.createRandom(3,4,rand);

        DMatrixRow_C32 B = new DMatrixRow_C32(1,1);
        B.set(3,4,true,A.data);

        assertTrue(MatrixFeatures_CR32.isEquals(A,B));

        DMatrixRow_C32 A_tran = new DMatrixRow_C32(4,3);
