 ...
 * @author Peter Abeles
 */
public class TestDMatrixRow_F64 {

    Random rand = new Random(23432);

    @Test
    public void testGeneric() {
        GenericTestsD1Matrix_F64 g;
        g = new GenericTestsD1Matrix_F64() {
            protected D1Matrix_F64 createMatrix(int numRows, int numCols) {
     ...
     *
     * DMatrixRow_F64( double data[] , int numCols , int numRows )
     */
    @Test
    public void testConstructorSingleArray()
    {
        ...
        DMatrixRow_F64 mat = new DMatrixRow_F64(3,2, true, d);
     ...
     * Tests the following constructor:
     *
     * DMatrixRow_F64( int numCols , int numRows )
     */
    @Test
    public void testConstructorShape() {
        DMatrixRow_F64 mat = new DMatrixRow_F64(7,5);
     ...
     * Tests the following constructor:
     *
     * DMatrixRow_F64( DMatrixRow_F64 orig )
     */
    @Test
    public void testConstructorCopy() {
        ...
        DMatrixRow_F64 mat = new DMatrixRow_F64(d);
        DMatrixRow_F64 copy = new DMatrixRow_F64(mat);
    ...
    public void wrap() {
        ...
        DMatrixRow_F64 mat = DMatrixRow_F64.wrap(3,2,d);
    ...
    public void testInBounds() {
        DMatrixRow_F64 mat = new DMatrixRow_F64(2,3);
    ...
    public void testSet_Matrix() {
        ...
        DMatrixRow_F64 mat = new DMatrixRow_F64(d);
        DMatrixRow_F64 mat2 = new DMatrixRow_F64(mat.numRows,mat.numCols);
    ...
    public void set_ColumnMajor() {
        ...
        DMatrixRow_F64 Atran = A.copy();
        CommonOps_R64.transpose(Atran);
        DMatrixRow_F64 Afound = new DMatrixRow_F64(3,5);
    ...
    public void testset_Matrix() {
        ...
        DMatrixRow_F64 mat = new DMatrixRow_F64(d);
        DMatrixRow_F64 mat2 = new DMatrixRow_F64(5,5);
