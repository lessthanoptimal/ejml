...
import org.ejml.dense.row.CommonOps_R32;
 ...
 * @author Peter Abeles
 */
public class TestDMatrixRow_F32 {
    ...
    public void testGeneric() {
        ...
        g = new GenericTestsD1Matrix_F32() {
            protected D1Matrix_F32 createMatrix(int numRows, int numCols) {
                return new DMatrixRow_F32(numRows,numCols);
            }
        };
     ...
     *
     * DMatrixRow_F32( float data[] , int numCols , int numRows )
     */
    @Test
    public void testConstructorSingleArray()
    {
        ...
        DMatrixRow_F32 mat = new DMatrixRow_F32(3,2, true, d);
     ...
     * Tests the following constructor:
     *
     * DMatrixRow_F32( float data[][] )
     */
    @Test
    public void testConstruactorFloatArray() {
        float d[][] = new float[][]{{1,2},{3,4},{5,6}};

        DMatrixRow_F32 mat = new DMatrixRow_F32(d);
     ...
     * Tests the following constructor:
     *
     * DMatrixRow_F32( int numCols , int numRows )
     */
    @Test
    public void testConstructorShape() {
        DMatrixRow_F32 mat = new DMatrixRow_F32(7,5);
     ...
     * Tests the following constructor:
     *
     * DMatrixRow_F32( DMatrixRow_F32 orig )
     */
    @Test
    public void testConstructorCopy() {
        ...
        DMatrixRow_F32 mat = new DMatrixRow_F32(d);
        DMatrixRow_F32 copy = new DMatrixRow_F32(mat);
    ...
    public void wrap() {
        ...
        DMatrixRow_F32 mat = DMatrixRow_F32.wrap(3,2,d);
    ...
    public void testInBounds() {
        DMatrixRow_F32 mat = new DMatrixRow_F32(2,3);
    ...
    public void testSet_Matrix() {
        ...
        DMatrixRow_F32 mat = new DMatrixRow_F32(d);
        DMatrixRow_F32 mat2 = new DMatrixRow_F32(mat.numRows,mat.numCols);
    ...
    public void set_ColumnMajor() {
        DMatrixRow_F32 A = RandomMatrices_R32.createRandom(3,5,rand);

        DMatrixRow_F32 Atran = A.copy();
        CommonOps_R32.transpose(Atran);
        DMatrixRow_F32 Afound = new DMatrixRow_F32(3,5);
    ...
    public void testset_Matrix() {
        ...
        DMatrixRow_F32 mat = new DMatrixRow_F32(d);
        DMatrixRow_F32 mat2 = new DMatrixRow_F32(5,5);
