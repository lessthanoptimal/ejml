...
public class TestD1Submatrix_F32 {
    ...
    @Test
    public void get() {
        RowMatrix_F32 A = RandomMatrices_D32.createRandom(5,10,-1,1,rand);
    ...
    public void extract() {
        ...
        RowMatrix_F32 E = CommonOps_D32.extract(A,2,4,1,10);

        assertTrue(MatrixFeatures_D32.isEquals(E,M));
    }
}
