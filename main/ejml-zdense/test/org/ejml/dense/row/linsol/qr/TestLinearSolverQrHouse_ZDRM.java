 ...
 * @author Peter Abeles
 */
public class TestLinearSolverQrHouse_ZDRM extends GenericLinearSolverChecks_ZDRM {

    public TestLinearSolverQrHouse_ZDRM() {
//         shouldFailSingular = false;
    }

    @Override
    protected LinearSolverDense<ZMatrixRMaj> createSolver( ZMatrixRMaj A ) {
        return new LinearSolverQrHouse_ZDRM();
    }
}
