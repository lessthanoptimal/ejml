...
/**
 * Test to see how well set and get are inlined in DMatrixRMaj.
 *
 * @author Peter Abeles
 */
public class BenchmarkInliningGetSet {
     ...
     */
    public static long benchGet(DMatrixRMaj A , int n ) {
     ...
     */
    public static long getUnsafeGet(DMatrixRMaj A , int n ) {
