...
public class BenchmarkMatrixMatrixMultTransAB {
    ...
    public static long mult(DMatrixRMaj matA , DMatrixRMaj matB ,
        ...
        for( int i = 0; i < numTrials; i++ ) {
            CommonOps_DDRM.multTransAB(matA,matB,matResult);
        }
    ...
    public static long multSmall(DMatrixRMaj matA , DMatrixRMaj matB ,
        ...
        for( int i = 0; i < numTrials; i++ ) {
            MatrixMatrixMult_DDRM.multTransAB(matA,matB,matResult);
        }
    ...
    public static long multAux(DMatrixRMaj matA , DMatrixRMaj matB ,
        ...
        for( int i = 0; i < numTrials; i++ ) {
            MatrixMatrixMult_DDRM.multTransAB_aux(matA,matB,matResult,null);
        }
