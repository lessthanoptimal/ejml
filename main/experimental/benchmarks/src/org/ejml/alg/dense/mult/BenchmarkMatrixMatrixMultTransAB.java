...
public class BenchmarkMatrixMatrixMultTransAB {
    ...
    public static long mult(RowMatrix_F64 matA , RowMatrix_F64 matB ,
        ...
        for( int i = 0; i < numTrials; i++ ) {
            CommonOps_R64.multTransAB(matA,matB,matResult);
        }
    ...
    public static long multSmall(RowMatrix_F64 matA , RowMatrix_F64 matB ,
        ...
        for( int i = 0; i < numTrials; i++ ) {
            MatrixMatrixMult_R64.multTransAB(matA,matB,matResult);
        }
    ...
    public static long multAux(RowMatrix_F64 matA , RowMatrix_F64 matB ,
        ...
        for( int i = 0; i < numTrials; i++ ) {
            MatrixMatrixMult_R64.multTransAB_aux(matA,matB,matResult,null);
        }
