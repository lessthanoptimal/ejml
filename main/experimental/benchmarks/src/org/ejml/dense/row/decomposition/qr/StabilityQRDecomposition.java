...
import static org.ejml.dense.row.factory.DecompositionFactory_R64.decomposeSafe;
...
public class StabilityQRDecomposition {
    ...
    public static double evaluate(QRDecomposition<DMatrixRow_F64> alg , DMatrixRow_F64 orig ) {
    ...
    public static double evaluate(QRPDecomposition_F64<DMatrixRow_F64> alg , DMatrixRow_F64 orig ) {
    ...
    public static void main( String args [] ) {
        ...
        for( int size = 5; size <= 15; size += 5 ) {
            ...
            DMatrixRow_F64 orig = RandomMatrices_R64.createRandom(2*size,size,-1,1,rand);
