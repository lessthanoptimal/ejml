...
public class BlockD3MatrixOps {
    ...
    public static BlockD3Matrix64F convert(DMatrixRow_F64 src , int blockLength )
    {
    ...
    public static BlockD3Matrix64F convert( DMatrixRow_F64 src )
    {
    ...
    public static void convert(DMatrixRow_F64 src , BlockD3Matrix64F dst )
    {
    ...
    public static void convert( BlockD3Matrix64F src , DMatrixRow_F64 dst )
    {
