...
/**
 * A slower but much simpler version of {@link BidiagonalDecompositionRow_R64} that internally uses
 ...
 * @author Peter Abeles
 */
public class BidiagonalDecompositionNaive_R64 {
    ...
    protected void computeU( int k) {
        ...
        if( max > 0 ) {
            ...
            SimpleMatrix Q_k = SimpleMatrix.wrap(SpecializedOps_R64.createReflector(this.u,nu/tau));
            U = U.mult(Q_k);
            B = Q_k.mult(B);
        }
    }
