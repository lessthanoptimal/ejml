...
public class MatrixMultFixedBlock {
    ...
    public void mult_2x6(DenseMatrix64F A , DenseMatrix64F B , DenseMatrix64F C ) {
        ...
        FixedOps6_D64.mult(a0_6, b00_6, tmp_6);
        FixedOps6_D64.multAdd(a1_6, b10_6, tmp_6);
        insert(tmp_6,C,0,0);

        FixedOps6_D64.mult(a0_6, b01_6, tmp_6);
        FixedOps6_D64.multAdd(a1_6,b11_6, tmp_6);
        insert(tmp_6,C,0,6);
    ...
    private void computeRow_4x3(DenseMatrix64F A, DenseMatrix64F C, int row) {
        ...
        FixedOps3_D64.multAdd(a2_3, b20_3, tmp_3);
        FixedOps3_D64.multAdd(a3_3, b30_3, tmp_3);
        insert(tmp_3,C,row,0);

        FixedOps3_D64.mult(a0_3, b01_3, tmp_3);
        FixedOps3_D64.multAdd(a1_3, b11_3, tmp_3);
        FixedOps3_D64.multAdd(a2_3, b21_3, tmp_3);
        FixedOps3_D64.multAdd(a3_3, b31_3, tmp_3);
        insert(tmp_3,C,row,3);

        FixedOps3_D64.mult(a0_3, b02_3, tmp_3);
        FixedOps3_D64.multAdd(a1_3, b12_3, tmp_3);
        FixedOps3_D64.multAdd(a2_3, b22_3, tmp_3);
        FixedOps3_D64.multAdd(a3_3, b32_3, tmp_3);
        insert(tmp_3,C,row,6);

        FixedOps3_D64.mult(a0_3, b03_3, tmp_3);
        FixedOps3_D64.multAdd(a1_3, b13_3, tmp_3);
        FixedOps3_D64.multAdd(a2_3, b23_3, tmp_3);
        FixedOps3_D64.multAdd(a3_3, b33_3, tmp_3);
