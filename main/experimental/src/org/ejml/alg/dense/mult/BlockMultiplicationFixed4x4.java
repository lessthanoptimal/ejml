 ...
 * @author Peter Abeles
 */
public class BlockMultiplicationFixed4x4 {
    ...
    public static void mult( int blockLength ,
                             ...
                             D1Submatrix64F C )
    {
        Fixed4x4Block a = new Fixed4x4Block(blockLength/4,blockLength/4);
        Fixed4x4Block b = new Fixed4x4Block(blockLength/4,blockLength/4);
        Fixed4x4Block c = new Fixed4x4Block(blockLength/4,blockLength/4);
