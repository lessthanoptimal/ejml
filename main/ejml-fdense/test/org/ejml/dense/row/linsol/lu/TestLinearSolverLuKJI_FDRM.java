 ...
 * @author Peter Abeles
 */
public class TestLinearSolverLuKJI_FDRM extends GenericLinearSolverChecks_FDRM {

    public TestLinearSolverLuKJI_FDRM() {
    ...
    protected LinearSolverDense<FMatrixRMaj> createSolver(FMatrixRMaj A ) {
        ...
        return new LinearSolverLuKJI_FDRM(decomp);
    }
}