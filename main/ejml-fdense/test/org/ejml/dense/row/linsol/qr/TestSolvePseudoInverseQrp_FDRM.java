 ...
 * @author Peter Abeles
 */
public class TestSolvePseudoInverseQrp_FDRM extends GenericLinearSolverChecks_FDRM {
    public TestSolvePseudoInverseQrp_FDRM() {
         shouldFailSingular = false;
    }

    @Override
    protected LinearSolverDense<FMatrixRMaj> createSolver(FMatrixRMaj A ) {
        return new SolvePseudoInverseQrp_FDRM(new QRColPivDecompositionHouseholderColumn_FDRM(),true);
    }

    @Test
    public void checkSingularBasic() {
        LinearSolverDense<FMatrixRMaj> solver =
                new SolvePseudoInverseQrp_FDRM(new QRColPivDecompositionHouseholderColumn_FDRM(),true);
    ...
    public void checkSingularFull() {
        LinearSolverDense<FMatrixRMaj> solver =
                new SolvePseudoInverseQrp_FDRM(new QRColPivDecompositionHouseholderColumn_FDRM(),false);
        GenericSolvePseudoInverseChecks_FDRM checks = new GenericSolvePseudoInverseChecks_FDRM(solver);
