 ...
 * @author Peter Abeles
 */
public class TestLinearSolverQrHouse_FDRM extends GenericLinearSolverChecks_FDRM {

    public TestLinearSolverQrHouse_FDRM() {
//         shouldFailSingular = false;
    }

    @Override
    protected LinearSolverDense<FMatrixRMaj> createSolver(FMatrixRMaj A ) {
        return new LinearSolverQrHouse_FDRM();
    }
}
