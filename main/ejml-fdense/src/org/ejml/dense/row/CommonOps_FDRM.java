...
public class CommonOps_FDRM {
     ...
     */
    public static <T extends FMatrix1Row> T mult(T a , T b , T output )
    {
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrix1Row> T mult(float alpha , T a , T b , T output )
    {
        output = reshapeOrDeclare(output,a,a.numRows,b.numCols);
        UtilEjml.checkSameInstance(a,output);
        UtilEjml.checkSameInstance(b,output);
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrix1Row> T multTransA(T a , T b , T output )
    {
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrix1Row> T multTransA(float alpha , T a , T b , T output )
    {
        output = reshapeOrDeclare(output,a,a.numCols,b.numCols);
        UtilEjml.checkSameInstance(a,output);
        UtilEjml.checkSameInstance(b,output);
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrix1Row> T multTransB(T a , T b , T output )
    {
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrix1Row> T multTransB(float alpha , T a , T b , T output )
    {
        output = reshapeOrDeclare(output,a,a.numRows,b.numRows);
        UtilEjml.checkSameInstance(a,output);
        UtilEjml.checkSameInstance(b,output);
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrix1Row> T multTransAB(T a , T b , T output )
    {
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrix1Row> T multTransAB(float alpha , T a , T b , T output )
    {
        output = reshapeOrDeclare(output,a,a.numCols,b.numRows);
        UtilEjml.checkSameInstance(a,output);
        UtilEjml.checkSameInstance(b,output);
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrix1Row> T multInner(T a , T output )
    {
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrix1Row> T multOuter(T a , T output )
    {
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrixD1> T elementMult(T A , T B , T output )
    {
        checkSameShape(A,B,true);
     ...
     * @param output Where the results of the operation are stored. Modified.
     */
    public static <T extends FMatrixD1> T elementDiv(T A , T B , T output )
    {
        checkSameShape(A,B,true);
        output = reshapeOrDeclare(output,A);
     ...
     */
    public static <T extends FMatrixD1> T elementPower(T A , T B , T output ) {
        checkSameShape(A,B,true);
        output = reshapeOrDeclare(output,A);
     ...
     * @param output output (modified)
     */
    public static <T extends FMatrixD1> T elementPower(float a , T B , T output )
    {
     ...
     * @param output output (modified)
     */
    public static <T extends FMatrixD1> T elementPower(T A , float b, T output ) {
        output = reshapeOrDeclare(output,A);
     ...
     * @return The results
     */
    public static <T extends FMatrixD1> T elementLog(T A , T output )
    {
        output = reshapeOrDeclare(output,A);
     ...
     * @return The results
     */
    public static <T extends FMatrixD1> T elementExp(T A , T output ) {
        output = reshapeOrDeclare(output,A);
     ...
     * @return The results.
     */
    public static <T extends FMatrixD1> T add(final T a , final T b , T output )
    {
        UtilEjml.checkSameShape(a,b, true);
     ...
     * @return The results.
     */
    public static <T extends FMatrixD1> T add(T a , float beta , T b , T output )
    {
        UtilEjml.checkSameShape(a,b, true);
        output = UtilEjml.reshapeOrDeclare(output, a);
     ...
     * @return The results.
     */
    public static <T extends FMatrixD1> T add(float alpha , T a , float beta , T b , T output )
    {
        UtilEjml.checkSameShape(a,b, true);
        output = UtilEjml.reshapeOrDeclare(output, a);
     ...
     * @return The resulting matrix
     */
    public static <T extends FMatrixD1> T subtract(T a , float val , T output ) {
        output = UtilEjml.reshapeOrDeclare(output, a);
     ...
     * @return The resulting matrix
     */
    public static <T extends FMatrixD1> T subtract(float val , T a , T output ) {
        output = UtilEjml.reshapeOrDeclare(output, a);
     ...
     * @return The resulting matrix
     */
    public static <T extends FMatrixD1> T subtract(T a, T b, T output)
    {
        UtilEjml.checkSameShape(a,b,true);
        output = UtilEjml.reshapeOrDeclare(output, a);
     ...
     * @return The resulting matrix
     */
    public static <T extends FMatrixD1> T divide(T input , float alpha  , T output)
    {
        output = UtilEjml.reshapeOrDeclare(output, input);
     ...
     */
    public static FMatrixRMaj apply(FMatrixRMaj input, FUnaryOperator func, FMatrixRMaj output) {
        output = UtilEjml.reshapeOrDeclare(output,input.numRows, input.numCols);
    ...
    public static FMatrixRMaj apply(FMatrixRMaj input, FUnaryOperator func) {
