...
public class TileRankUpdate_F64 {
    /// c = c - a<sup>T</sup>b, where `a` and `b` are tiles inside of `dataAB`
    protected static void tileMultMinusTransA( double[] dataAB, double[] dataC,
...
//        }
        ...
        for (int i = 0; i < widthA; i++) {
            ...
            for (; j < jBlockedEnd; j += 4) {
                ...
                int aIdx = offsetA + i;       // dataAB[k*widthA + i]
                int bIdx = offsetB + j;       // dataAB[k*widthC + j]
...
//        }
    ...
    /// c = c - a\*b<sup>T</sup>, where `a` and `b` are tiles inside of `dataAB`
    protected static void tileMultMinusTransB( final double[] dataAB, final double[] dataC,
                                               final int widthA, final int heightA, final int widthC,
                                               final int offsetA, final int offsetB, final int offsetC ) {
