...
public class TestSpecializedOps_DDRM extends EjmlStandardJUnit {
    @Test void createReflector() {
    ...
    @Test void createReflector_gamma() {
        DMatrixRMaj u = RandomMatrices_DDRM.rectangle(4, 1, rand);
        double gamma = 1.5;
    ...
    @Test void elementDiagonalMaxAbs() {
        DMatrixRMaj A = RandomMatrices_DDRM.rectangle(4, 5, rand);
