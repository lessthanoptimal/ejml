...
public class DSubmatrixD1 extends Submatrix<DMatrixD1> {
    ...
    /// Copies the fields from src into this Object. Returns a reference to this object.
    public DSubmatrixD1 setTo( DSubmatrixD1 src ) {
        set(src.original, src.row0, src.row1, src.col0, src.col1);
        return this;
    }
