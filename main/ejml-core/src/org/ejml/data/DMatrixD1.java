...
public abstract class DMatrixD1 implements ReshapeMatrix, DMatrix {
    ...
    @Getter public double[] data = UtilEjml.ZERO_LENGTH_F64;
    ...
    ///
    /// Equivalent to: {@code this.data[index] += val};
    ///
    ...
    /// @param saveValues If true then the value of each element will be save using a row-major reordering. Typically,
    ...
    @Override public String toString() {
        return getClass().getSimpleName() + " " + getNumRows() + "x" + getNumCols() + "\n" + format();}
}
