...
public interface MatrixSparse extends ReshapeMatrix, MapFormattable {
    ...
    /// be empty/all zeros. Similar to [#reshape(int, int, int)], but the storage for non-zero elements is
    /// not changed
    ///
    /// @param numRows number of rows
    /// @param numCols number of columns
    @Override void reshape( int numRows, int numCols );
