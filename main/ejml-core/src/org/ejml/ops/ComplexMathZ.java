...
public class ComplexMathZ
{
     ...
     */
    public static void conj(ZComplex input , ZComplex conj ) {
     ...
     */
    public static void plus(ZComplex a , ZComplex b , ZComplex result ) {
     ...
     * @param result Storage for output
     */
    public static void minus(ZComplex a , ZComplex b , ZComplex result ) {
        result.real = a.real - b.real;
        result.imaginary = a.imaginary - b.imaginary;
    }
     ...
     * @param result Storage for output
     */
    public static void multiply(ZComplex a, ZComplex b, ZComplex result) {
     ...
     * @param result Storage for output
     */
    public static void divide(ZComplex a, ZComplex b, ZComplex result) {
     ...
     */
    public static void convert(ZComplex input , ZComplexPolar output ) {
     ...
     * @param output Polar notation
     */
    public static void convert(ZComplexPolar input , ZComplex output ) {
     ...
     * @param result Storage for output.
     */
    public static void multiply(ZComplexPolar a, ZComplexPolar b, ZComplexPolar result)
    {
        result.r = a.r*b.r;
     ...
     * @param result Storage for output.
     */
    public static void divide(ZComplexPolar a, ZComplexPolar b, ZComplexPolar result)
    {
        result.r = a.r/b.r;
        result.theta = a.theta - b.theta;
    }
     ...
     * @param result Result
     */
    public static void pow(ZComplexPolar a , int N , ZComplexPolar result )
    {
     ...
     */
    public static void root(ZComplexPolar a , int N , int k , ZComplexPolar result )
    {
     ...
     * @param result Computed root
     */
    public static void root(ZComplex a , int N , int k , ZComplex result )
    {
     ...
     */
    public static void sqrt(ZComplex input, ZComplex root)
    {
