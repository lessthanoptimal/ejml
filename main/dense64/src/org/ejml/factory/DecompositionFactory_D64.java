...
import org.ejml.alg.dense.decomposition.eig.SwitchingEigenDecomposition_D64;
 ...
 * @author Peter Abeles
 */
public class DecompositionFactory_D64 {
    ...
    public static double quality( DenseMatrix64F orig , DenseMatrix64F U , DenseMatrix64F W , DenseMatrix64F Vt )
    {
        ...
        return SpecializedOps_D64.diffNormF(orig,foundA)/normA;
    }
    ...
    public static double quality( DenseMatrix64F orig , EigenDecomposition_F64<DenseMatrix64F> eig )
    {
        ...
        double bottom = NormOps_D64.normF(L);
