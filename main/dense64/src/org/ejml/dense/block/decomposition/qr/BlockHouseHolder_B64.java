...
import org.ejml.dense.block.InnerMultiplication_B64;
import org.ejml.dense.block.VectorOps_B64;
 ...
 * @author Peter Abeles
 */
public class BlockHouseHolder_B64 {
    ...
    public static boolean computeHouseHolderRow( final int blockLength, final D1Submatrix_F64 Y,
        ...
        if( max == 0.0 ) {
            ...
            VectorOps_B64.div_row(blockLength,Y,i,u_0,Y,i,i+1,Y.col1-Y.col0);
...
//                    for( int k = 0; k < height; k++ ) {
    ...
    public static void add_row(final int blockLength ,
        ...
        VectorOps_B64.add_row(blockLength,A,rowA,alpha,B,rowB,beta,C,rowC,offset+1,end);
    }
    ...
    public static void scale_row( final int blockLength ,
        ...
        VectorOps_B64.scale_row(blockLength,Y,row,val,W,row,offset+1,Y.col1-Y.col0);
    }
            ...
            for( int j = B.col0; j < B.col1; j += blockLength ) {
                ...
                for( int k = Y.col0; k < Y.col1; k += blockLength ) {
                    ...
                    if( i == Y.row0 ) {
                        ...
                        InnerMultiplication_B64.blockMultPlus(Y.original.data,B.original.data,C.original.data,
                                indexY,indexB,indexC,heightY,widthY,widthB);
                    }
                }
            }
        ...
        for( int j = B.col0; j < B.col1; j += blockLength ) {
            ...
            for( int k = A.row0; k < A.row1; k += blockLength ) {
                ...
                if( k == A.row0 )
                    ...
                    InnerMultiplication_B64.blockMultPlusTransA(A.original.data,B.original.data,C.original.data,
                            indexA,indexB,indexC,heightA,widthA,widthB);
            }
        }
    }
