...
import org.ejml.dense.row.linsol.LinearSolverAbstract_R64;
 ...
 * @author Peter Abeles
 */
public class LinearSolverCholLDL_R64 extends LinearSolverAbstract_R64 {

    private CholeskyDecompositionLDL_R64 decomposer;
    private int n;
    private double vv[];
    private double el[];
    private double d[];

    public LinearSolverCholLDL_R64(CholeskyDecompositionLDL_R64 decomposer) {
        this.decomposer = decomposer;
    }

    public LinearSolverCholLDL_R64() {
        this.decomposer = new CholeskyDecompositionLDL_R64();
    }
    ...
    public /**/double quality() {
        return Math.abs(SpecializedOps_R64.diagProd(decomposer.getL()));
    }
    ...
    private void solveInternal() {
        ...
        TriangularSolver_R64.solveL(el,vv,n);
        ...
        // solve L^T*x=y
        TriangularSolver_R64.solveTranL(el,vv,n);
    }
     ...
     */
    @Override
    public void invert( DMatrixRow_F64 inv ) {
    ...
    @Override
    public CholeskyLDLDecomposition_F64<DMatrixRow_F64> getDecomposition() {
        return decomposer;
    }
}