 ...
 * @author Peter Abeles
 */
public class LinearSolverQrHouseTran_R64 extends LinearSolverAbstract_R64 {

    private QRDecompositionHouseholderTran_R64 decomposer;
    ...
    private DMatrixRow_F64 QR; // a column major QR matrix
    private DMatrixRow_F64 U;

    /**
     * Creates a linear solver that uses QR decomposition.
     */
    public LinearSolverQrHouseTran_R64() {
        decomposer = new QRDecompositionHouseholderTran_R64();
    }
    ...
    public void solve(DMatrixRow_F64 B, DMatrixRow_F64 X) {
        ...
        for( int colB = 0; colB < BnumCols; colB++ ) {
            ...
            TriangularSolver_R64.solveU(U.data,a,numCols);
