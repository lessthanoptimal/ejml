...
import org.ejml.dense.row.decomposition.qr.QRDecompositionHouseholder_R64;
 ...
 * @author Peter Abeles
 */
public class LinearSolverQrHouse_R64 extends LinearSolverAbstract_R64 {

    private QRDecompositionHouseholder_R64 decomposer;
     ...
     */
    public LinearSolverQrHouse_R64() {
        decomposer = new QRDecompositionHouseholder_R64();
    ...
    public /**/double quality() {
        return SpecializedOps_R64.qualityTriangular(QR);
    }
    ...
    public void solve(DMatrixRow_F64 B, DMatrixRow_F64 X) {
        ...
        for( int colB = 0; colB < BnumCols; colB++ ) {
            ...
            TriangularSolver_R64.solveU(QR.data,a,numCols);
