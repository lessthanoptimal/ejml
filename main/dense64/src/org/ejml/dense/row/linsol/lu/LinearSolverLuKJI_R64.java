 ...
 * There seems to be no performance benit relative to {@link LinearSolverLu_R64} in this approach
 * and b and x can't be the same instance, which means it has slightly less functionality.
 *
 * @author Peter Abeles
 */
public class LinearSolverLuKJI_R64 extends LinearSolverLuBase_R64 {

    private double []dataLU;
    private int[] pivot;

    public LinearSolverLuKJI_R64(LUDecompositionBase_R64 decomp) {
        super(decomp);
    ...
    public void solve(DMatrixRow_F64 b, DMatrixRow_F64 x) {
        ...
        if( b != x ) {
            SpecializedOps_R64.copyChangeRow(pivot,b,x);
        } else {
