 ...
 * @author Peter Abeles
 */
public class LinearSolverLu_R64 extends LinearSolverLuBase_R64 {

    boolean doImprove = false;

    public LinearSolverLu_R64(LUDecompositionBase_R64 decomp) {
        super(decomp);
    }

    public LinearSolverLu_R64(LUDecompositionBase_R64 decomp, boolean doImprove) {
        super(decomp);
