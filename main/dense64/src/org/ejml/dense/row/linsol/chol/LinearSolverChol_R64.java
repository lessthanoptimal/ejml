 ...
 * @author Peter Abeles
 */
public class LinearSolverChol_R64 extends LinearSolverAbstract_R64 {

    CholeskyDecompositionCommon_R64 decomposer;
    int n;
    double vv[];
    double t[];

    public LinearSolverChol_R64(CholeskyDecompositionCommon_R64 decomposer) {
    ...
    public /**/double quality() {
        return SpecializedOps_R64.qualityTriangular(decomposer.getT());
    }
    ...
    private void solveInternalL() {
        ...
        TriangularSolver_R64.solveL(t,vv,n);

        // solve L^T*x=y
        TriangularSolver_R64.solveTranL(t,vv,n);
    }
    ...
    @Override
    public CholeskyDecomposition_F64<DMatrixRow_F64> getDecomposition() {
        return decomposer;
    }
}
