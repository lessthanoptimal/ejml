 ...
 * @author Peter Abeles
 */
public abstract class LinearSolverLuBase_R64 extends LinearSolverAbstract_R64 {

    protected LUDecompositionBase_R64 decomp;

    public LinearSolverLuBase_R64(LUDecompositionBase_R64 decomp) {
        this.decomp = decomp;
...
//                vv[i] = sdp.doubleValue();
    ...
    @Override
    public LUDecompositionBase_R64 getDecomposition() {
        return decomp;
    }
}