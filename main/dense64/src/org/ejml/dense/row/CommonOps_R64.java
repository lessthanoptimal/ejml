...
import org.ejml.dense.row.mult.MatrixMultProduct_R64;
import org.ejml.dense.row.mult.MatrixVectorMult_R64;
 ...
 * </p>
 * <p>
 * For more exotic and specialized generic operations see {@link SpecializedOps_R64}.
 * </p>
 * @see MatrixMatrixMult_R64
 * @see MatrixVectorMult_R64
 * @see SpecializedOps_R64
 * @see MatrixFeatures_R64
 *
 * @author Peter Abeles
 */
@SuppressWarnings({"ForLoopReplaceableByForEach"})
public class CommonOps_R64 {
    /**
    ...
    public static void mult(D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        if( b.numCols == 1 ) {
            ...
            MatrixMatrixMult_R64.mult_reorder(a,b,c);
        } else {
            MatrixMatrixMult_R64.mult_small(a,b,c);
        }
    }
    ...
    public static void mult(double alpha , D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        ...
        if( b.numCols >= EjmlParameters.MULT_COLUMN_SWITCH ) {
            MatrixMatrixMult_R64.mult_reorder(alpha, a, b, c);
        } else {
            MatrixMatrixMult_R64.mult_small(alpha,a,b,c);
        }
    }
    ...
    public static void multTransA(D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        if( b.numCols == 1 ) {
            ...
            MatrixMatrixMult_R64.multTransA_reorder(a, b, c);
        } else {
            MatrixMatrixMult_R64.multTransA_small(a, b, c);
        }
    }
    ...
    public static void multTransA(double alpha , D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        ...
        if( a.numCols >= EjmlParameters.MULT_COLUMN_SWITCH ||
                b.numCols >= EjmlParameters.MULT_COLUMN_SWITCH ) {
            MatrixMatrixMult_R64.multTransA_reorder(alpha, a, b, c);
        } else {
            MatrixMatrixMult_R64.multTransA_small(alpha, a, b, c);
        }
    }
    ...
    public static void multTransB(D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        if( b.numRows == 1 ) {
            ...
            MatrixMatrixMult_R64.multTransB(a, b, c);
        }
    }
    ...
    public static void multTransAB(D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        if( b.numRows == 1) {
            ...
            MatrixMatrixMult_R64.multTransAB_aux(a, b, c, null);
        } else {
            MatrixMatrixMult_R64.multTransAB(a, b, c);
        }
    }
    ...
    public static void multTransAB(double alpha , D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        ...
        if( a.numCols >= EjmlParameters.MULT_TRANAB_COLUMN_SWITCH ) {
            MatrixMatrixMult_R64.multTransAB_aux(alpha, a, b, c, null);
        } else {
            MatrixMatrixMult_R64.multTransAB(alpha, a, b, c);
        }
    }
    ...
    public static double dot(D1Matrix_F64 a , D1Matrix_F64 b ) {
        ...
        return VectorVectorMult_R64.innerProd(a,b);
    }
     ...
     * vectors there is an even faster option, see {@link VectorVectorMult_R64#innerProd(D1Matrix_F64, D1Matrix_F64)}
     * </p>
     *
    ...
    public static void multInner(D1MatrixRow_F64 a , D1MatrixRow_F64 c )
    {
        ...
        if( a.numCols >= EjmlParameters.MULT_INNER_SWITCH ) {
            MatrixMultProduct_R64.inner_small(a, c);
        } else {
            MatrixMultProduct_R64.inner_reorder(a, c);
        }
    }
    ...
    public static void multOuter(D1MatrixRow_F64 a , D1MatrixRow_F64 c )
    {
        ...
        MatrixMultProduct_R64.outer(a, c);
    }
    ...
    public static void multAdd(D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        if( b.numCols == 1 ) {
            ...
            if( b.numCols >= EjmlParameters.MULT_COLUMN_SWITCH ) {
                MatrixMatrixMult_R64.multAdd_reorder(a,b,c);
            } else {
                MatrixMatrixMult_R64.multAdd_small(a,b,c);
            }
        }
    }
    ...
    public static void multAdd(double alpha , D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        // TODO add a matrix vectory multiply here
        if( b.numCols >= EjmlParameters.MULT_COLUMN_SWITCH ) {
            MatrixMatrixMult_R64.multAdd_reorder(alpha, a, b, c);
        } else {
            MatrixMatrixMult_R64.multAdd_small(alpha,a,b,c);
        }
    }
    ...
    public static void multAddTransA(D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        if( b.numCols == 1 ) {
            ...
            if( a.numCols >= EjmlParameters.MULT_COLUMN_SWITCH ||
                    b.numCols >= EjmlParameters.MULT_COLUMN_SWITCH  ) {
                MatrixMatrixMult_R64.multAddTransA_reorder(a, b, c);
            } else {
                MatrixMatrixMult_R64.multAddTransA_small(a, b, c);
            }
        }
    }
    ...
    public static void multAddTransA(double alpha , D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        ...
        if( a.numCols >= EjmlParameters.MULT_COLUMN_SWITCH ||
                b.numCols >= EjmlParameters.MULT_COLUMN_SWITCH ) {
            MatrixMatrixMult_R64.multAddTransA_reorder(alpha, a, b, c);
        } else {
            MatrixMatrixMult_R64.multAddTransA_small(alpha, a, b, c);
        }
    }
    ...
    public static void multAddTransAB(D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        if( b.numRows == 1 ) {
            ...
            MatrixMatrixMult_R64.multAddTransAB_aux(a,b,c,null);
        } else {
            MatrixMatrixMult_R64.multAddTransAB(a,b,c);
        }
    }
    ...
    public static void multAddTransAB(double alpha , D1MatrixRow_F64 a , D1MatrixRow_F64 b , D1MatrixRow_F64 c )
    {
        // TODO add a matrix vectory multiply here
        if( a.numCols >= EjmlParameters.MULT_TRANAB_COLUMN_SWITCH ) {
            MatrixMatrixMult_R64.multAddTransAB_aux(alpha, a, b, c, null);
        } else {
            MatrixMatrixMult_R64.multAddTransAB(alpha, a, b, c);
        }
    }
     ...
     *
     * <p>
     * If repeat calls to solve are being made then one should consider using {@link LinearSolverFactory_R64}
     * instead.
     * </p>
     *
     * <p>
     ...
     */
    public static boolean solve(DMatrixRow_F64 a , DMatrixRow_F64 b , DMatrixRow_F64 x )
    {
     ...
     * {@link #transpose(DMatrixRow_F64, DMatrixRow_F64)} is invoked.
     * </p>
     *
     * @param mat The matrix that is to be transposed. Modified.
     */
    public static void transpose( DMatrixRow_F64 mat ) {
        if( mat.numCols == mat.numRows ){
            TransposeAlgs_R64.square(mat);
        } else {
            DMatrixRow_F64 b = new DMatrixRow_F64(mat.numCols,mat.numRows);
            transpose(mat,b);
            mat.set(b);
        }
    }
     ...
     */
    public static DMatrixRow_F64 transpose(DMatrixRow_F64 A, DMatrixRow_F64 A_tran)
    {
        if( A_tran == null ) {
            A_tran = new DMatrixRow_F64(A.numCols,A.numRows);
        } else {
        ...
        if( A.numRows > EjmlParameters.TRANSPOSE_SWITCH &&
            ...
            TransposeAlgs_R64.block(A,A_tran,EjmlParameters.BLOCK_WIDTH);
        else
            TransposeAlgs_R64.standard(A,A_tran);
     ...
     * needed, then using {@link org.ejml.dense.row.decomposition.lu.LUDecompositionAlt_R64} directly (or any
     * similar algorithm) can be more efficient.
     *
     * @param mat The matrix whose determinant is to be computed.  Not modified.
     * @return The determinant.
     */
    public static double det( DMatrixRow_F64 mat )
    {
        ...
        if( numCol != numRow ) {
        ...
        } else if( numCol <= UnrolledDeterminantFromMinor_R64.MAX ) {
            ...
            if( numCol >= 2 ) {
                return UnrolledDeterminantFromMinor_R64.det(mat);
            } else {
                return mat.get(0);
            }
        } else {
     ...
     * @return true if it could invert the matrix false if it could not.
     */
    public static boolean invert( DMatrixRow_F64 mat) {
        if( mat.numCols <= UnrolledInverseFromMinor_R64.MAX ) {
            if( mat.numCols != mat.numRows ) {
                throw new IllegalArgumentException("Must be a square matrix.");
            }

            if( mat.numCols >= 2 ) {
                UnrolledInverseFromMinor_R64.inv(mat,mat);
            } else {
     ...
     * {@link LinearSolverFactory_R64} instead.
     * </p>
     *
     ...
     * @return true if it could invert the matrix false if it could not.
     */
    public static boolean invert(DMatrixRow_F64 mat, DMatrixRow_F64 result ) {
        if( mat.numCols <= UnrolledInverseFromMinor_R64.MAX ) {
            if( mat.numCols != mat.numRows ) {
                throw new IllegalArgumentException("Must be a square matrix.");
            }
            if( result.numCols >= 2 ) {
                UnrolledInverseFromMinor_R64.inv(mat,result);
            } else {
     ...
     * </p>
     * <p>
     * Internally it uses {@link SolvePseudoInverseSvd_R64} to compute the inverse.  For performance reasons, this should only
     ...
     * @return
     */
    public static void pinv(DMatrixRow_F64 A , DMatrixRow_F64 invA )
    {
        LinearSolver<DMatrixRow_F64> solver = LinearSolverFactory_R64.pseudoInverse(true);
        if( solver.modifiesA())
            A = A.copy();
     ...
     */
    public static DMatrixRow_F64[] columnsToVector(DMatrixRow_F64 A, DMatrixRow_F64[] v)
    {
        DMatrixRow_F64[]ret;
        if( v == null || v.length < A.numCols ) {
            ret = new DMatrixRow_F64[ A.numCols ];
        } else {
            ret = v;
        }
        ...
        for( int i = 0; i < ret.length; i++ ) {
            if( ret[i] == null ) {
                ret[i] = new DMatrixRow_F64(A.numRows,1);
            } else {
                ret[i].reshape(A.numRows,1, false);
            }

            DMatrixRow_F64 u = ret[i];
     ...
     * @return An array of vectors.
     */
    public static DMatrixRow_F64[] rowsToVector(DMatrixRow_F64 A, DMatrixRow_F64[] v)
    {
        DMatrixRow_F64[]ret;
        if( v == null || v.length < A.numRows ) {
            ret = new DMatrixRow_F64[ A.numRows ];
        } else {
            ret = v;
        }
        ...
        for( int i = 0; i < ret.length; i++ ) {
            if( ret[i] == null ) {
                ret[i] = new DMatrixRow_F64(A.numCols,1);
            } else {
     ...
     */
    public static DMatrixRow_F64 identity(int width )
    {
        DMatrixRow_F64 ret = new DMatrixRow_F64(width,width);
     ...
     */
    public static DMatrixRow_F64 identity(int numRows , int numCols )
    {
     ...
     * @return A new matrix.
     */
    public static DMatrixRow_F64 diag(double ...diagEl )
    {
     ...
     * @see #diag(double...)
     */
    public static DMatrixRow_F64 diag(DMatrixRow_F64 ret , int width , double ...diagEl )
    {
        if( ret == null ) {
            ret = new DMatrixRow_F64(width,width);
        } else {
            if( ret.numRows != width || ret.numCols != width )
                throw new IllegalArgumentException("Unexpected matrix size");

            CommonOps_R64.fill(ret, 0);
        }
     ...
     * @return A new matrix.
     */
    public static DMatrixRow_F64 diagR(int numRows , int numCols , double ...diagEl )
    {
        DMatrixRow_F64 ret = new DMatrixRow_F64(numRows,numCols);
     ...
     */
    public static void kron(DMatrixRow_F64 A , DMatrixRow_F64 B , DMatrixRow_F64 C )
    {
                                ...
                                int dstY0, int dstX0 )
    {
        ...
        if( src instanceof DMatrixRow_F64 && dst instanceof DMatrixRow_F64) {
            ImplCommonOps_R64.extract((DMatrixRow_F64)src,srcY0,srcX0,(DMatrixRow_F64)dst,dstY0,dstX0, h, w);
        } else {
     ...
     */
    public static DMatrixRow_F64 extract(DMatrixRow_F64 src,
                                        int srcY0, int srcY1,
                                        int srcX0, int srcX1 )
    {
        ...
        DMatrixRow_F64 dst = new DMatrixRow_F64(h,w);

        ImplCommonOps_R64.extract(src,srcY0,srcX0,dst,0,0, h, w);
     ...
     */
    public static void extract( DMatrixRow_F64 src,
                                int rows[] , int rowsSize ,
                                int cols[] , int colsSize , DMatrixRow_F64 dst ) {
     ...
     */
    public static void extract(DMatrixRow_F64 src, int indexes[] , int length , DMatrixRow_F64 dst ) {
        if( !MatrixFeatures_R64.isVector(dst))
     ...
     * @param colsSize maximum element in column array
     */
    public static void insert( DMatrixRow_F64 src ,
                               DMatrixRow_F64 dst ,
                                int rows[] , int rowsSize ,
     ...
     */
    public static void extractDiag(DMatrixRow_F64 src, DMatrixRow_F64 dst )
    {
     ...
     */
    public static DMatrixRow_F64 extractRow(DMatrixRow_F64 a , int row , DMatrixRow_F64 out ) {
        if( out == null)
            out = new DMatrixRow_F64(1,a.numCols);
        else if( !MatrixFeatures_R64.isVector(out) || out.getNumElements() != a.numCols )
     ...
     */
    public static DMatrixRow_F64 extractColumn(DMatrixRow_F64 a , int column , DMatrixRow_F64 out ) {
        if( out == null)
            out = new DMatrixRow_F64(a.numRows,1);
        else if( !MatrixFeatures_R64.isVector(out) || out.getNumElements() != a.numRows )
     ...
     */
    public static DMatrixRow_F64 sumRows(DMatrixRow_F64 input , DMatrixRow_F64 output ) {
        if( output == null ) {
            output = new DMatrixRow_F64(input.numRows,1);
     ...
     * @return Vector containing the sum of each row in the input.
     */
    public static DMatrixRow_F64 sumCols(DMatrixRow_F64 input , DMatrixRow_F64 output ) {
        if( output == null ) {
            output = new DMatrixRow_F64(1,input.numCols);
     ...
     * </p>
     *
     * @see RrefGaussJordanRowPivot_R64
     *
     ...
     */
    public static DMatrixRow_F64 rref(DMatrixRow_F64 A , int numUnknowns, DMatrixRow_F64 reduced ) {
        if( reduced == null ) {
            reduced = new DMatrixRow_F64(A.numRows,A.numCols);
        ...
        ReducedRowEchelonForm_F64<DMatrixRow_F64> alg = new RrefGaussJordanRowPivot_R64();
     ...
     */
    public static DMatrixRow_B elementLessThan(DMatrixRow_F64 A , double value , DMatrixRow_B output )
    {
        if( output == null ) {
            output = new DMatrixRow_B(A.numRows,A.numCols);
        }
     ...
     * @return Boolean matrix with results
     */
    public static DMatrixRow_B elementLessThanOrEqual(DMatrixRow_F64 A , double value , DMatrixRow_B output )
    {
        if( output == null ) {
            output = new DMatrixRow_B(A.numRows,A.numCols);
        }
     ...
     * @return Boolean matrix with results
     */
    public static DMatrixRow_B elementMoreThan(DMatrixRow_F64 A , double value , DMatrixRow_B output )
    {
        if( output == null ) {
            output = new DMatrixRow_B(A.numRows,A.numCols);
        }
     ...
     * @return Boolean matrix with results
     */
    public static DMatrixRow_B elementMoreThanOrEqual(DMatrixRow_F64 A , double value , DMatrixRow_B output )
    {
        if( output == null ) {
            output = new DMatrixRow_B(A.numRows,A.numCols);
        }
     ...
     * @return Boolean matrix with results
     */
    public static DMatrixRow_B elementLessThan(DMatrixRow_F64 A , DMatrixRow_F64 B , DMatrixRow_B output )
    {
        if( output == null ) {
            output = new DMatrixRow_B(A.numRows,A.numCols);
        }
     ...
     * @return Boolean matrix with results
     */
    public static DMatrixRow_B elementLessThanOrEqual(DMatrixRow_F64 A , DMatrixRow_F64 B , DMatrixRow_B output )
    {
        if( output == null ) {
            output = new DMatrixRow_B(A.numRows,A.numCols);
        }
     ...
     */
    public static DMatrixRow_F64 elements(DMatrixRow_F64 A , DMatrixRow_B marked , DMatrixRow_F64 output ) {
     ...
     */
    public static int countTrue(DMatrixRow_B A) {
        int total = 0;
