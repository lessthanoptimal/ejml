...
import org.ejml.dense.row.EigenOps_R64;
...
import org.ejml.dense.row.decomposition.chol.CholeskyDecomposition_B64_to_R64;
import org.ejml.dense.row.decomposition.eig.SwitchingEigenDecomposition_R64;
import org.ejml.dense.row.decomposition.eig.SymmetricQRAlgorithmDecomposition_R64;
import org.ejml.dense.row.decomposition.eig.WatchedDoubleStepQRDecomposition_R64;
...
import org.ejml.dense.row.decomposition.qr.QRDecompositionHouseholderColumn_R64;
import org.ejml.dense.row.decomposition.svd.SvdImplicitQrDecompose_R64;
...
public class DecompositionFactory_R64 {
    ...
    /**
     * <p>
     * Returns a {@link org.ejml.dense.row.decomposition.chol.CholeskyDecompositionLDL_R64} that has been optimized for the specified matrix size.
     * </p>
     *
     * @param matrixSize Number of rows and columns that the returned decomposition is optimized for.
