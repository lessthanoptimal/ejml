...
public class NormOps_R64 {
    ...
    public static double conditionP2( DMatrixRow_F64 A )
    {
        ...
        int n = SingularOps_R64.rank(svd,UtilEjml.TEST_F64);
    ...
    public static double normF( D1Matrix_F64 a ) {
        ...
        double scale = CommonOps_R64.elementMaxAbs(a);
    ...
    public static double elementP(D1MatrixRow_F64 A , double p ) {
        if( p == 1 ) {
            ...
            double max = CommonOps_R64.elementMaxAbs(A);
