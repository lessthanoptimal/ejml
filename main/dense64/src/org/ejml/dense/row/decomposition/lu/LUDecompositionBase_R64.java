...
public abstract class LUDecompositionBase_R64
    ...
    public DMatrixRow_F64 getLower(DMatrixRow_F64 lower )
    {
        ...
        lower = UtilDecompositons_R64.checkZerosUT(lower,numRows,numCols);
    ...
    public DMatrixRow_F64 getUpper(DMatrixRow_F64 upper )
    {
        ...
        upper = UtilDecompositons_R64.checkZerosLT(upper,numRows,numCols);
    ...
    public /**/double quality() {
        return SpecializedOps_R64.qualityTriangular(LU);
    }
...
//                    sum -= dataLU[i* n +j]*vv[j];
        ...
        // Solve U*X = Y;
        TriangularSolver_R64.solveU(dataLU,vv,n);
    }
