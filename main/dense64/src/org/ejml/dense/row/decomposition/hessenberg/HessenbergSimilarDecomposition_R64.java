...
public class HessenbergSimilarDecomposition_R64
     ...
     */
    public HessenbergSimilarDecomposition_R64(int initialSize) {
        gammas = new double[ initialSize ];
        b = new double[ initialSize ];
        u = new double[ initialSize ];
    }

    public HessenbergSimilarDecomposition_R64() {
        this(5);
    }
    ...
    public DMatrixRow_F64 getQ(DMatrixRow_F64 Q ) {
        ...
        for( int j = N-2; j >= 0; j-- ) {
            ...
            QrHelperFunctions_R64.rank1UpdateMultR(Q, u, gammas[j], j + 1, j + 1, N, b);
        }
    ...
    private boolean _decompose() {
        ...
        for( int k = 0; k < N-2; k++ ) {
            ...
            if( max > 0 ) {
                ...
                QrHelperFunctions_R64.rank1UpdateMultR(QH, u, gamma, k + 1, k + 1, N, b);

                // ---------- multiply on the right by Q_k
                QrHelperFunctions_R64.rank1UpdateMultL(QH, u, gamma, 0, k + 1, N);
