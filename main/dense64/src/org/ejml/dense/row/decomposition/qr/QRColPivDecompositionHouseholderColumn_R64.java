 ...
 * code reuse it extends {@link QRDecompositionHouseholderColumn_R64} and functions from that class
        ...
        implements QRPDecomposition_F64<DMatrixRow_F64>
{
     ...
     */
    public QRColPivDecompositionHouseholderColumn_R64(double singularThreshold) {
        this.singularThreshold = singularThreshold;
    }

    public QRColPivDecompositionHouseholderColumn_R64() {
    }
    ...
    public DMatrixRow_F64 getQ(DMatrixRow_F64 Q , boolean compact ) {
        if( compact ) {
            ...
            if( Q == null ) {
                Q = CommonOps_R64.identity(numRows);
            } else {
    ...
    public boolean decompose( DMatrixRow_F64 A ) {
        ...
        maxAbs = CommonOps_R64.elementMaxAbs(A);
