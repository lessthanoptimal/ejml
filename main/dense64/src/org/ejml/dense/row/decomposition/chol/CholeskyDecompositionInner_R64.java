 ...
 * decomposition is significantly faster.  This is faster on smaller matrices than {@link CholeskyDecompositionBlock_R64}
 * but much slower on larger matrices.
 * </p>
 *
 * @author Peter Abeles
 */
public class CholeskyDecompositionInner_R64 extends CholeskyDecompositionCommon_R64 {

    public CholeskyDecompositionInner_R64() {
        super(true);
    }

    public CholeskyDecompositionInner_R64(boolean lower) {
        super(lower);
    }
