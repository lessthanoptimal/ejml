...
import org.ejml.dense.row.decomposition.bidiagonal.BidiagonalDecompositionTall_R64;
...
public class SvdImplicitQrDecompose_R64 implements SingularValueDecomposition_F64<DMatrixRow_F64> {
     ...
     */
    public SvdImplicitQrDecompose_R64(boolean compact, boolean computeU, boolean computeV,
...
//        System.out.println("  compute UV "+(pointB-pointA)+"  QR = "+(pointC-pointB));
    ...
    private boolean setup(DMatrixRow_F64 orig) {
        ...
        if( canUseTallBidiagonal && numRows > numCols * 2 && !computeU ) {
            if( bidiag == null || !(bidiag instanceof BidiagonalDecompositionTall_R64) ) {
                bidiag = new BidiagonalDecompositionTall_R64();
            }
        } else if( bidiag == null || !(bidiag instanceof BidiagonalDecompositionRow_R64) ) {
            bidiag = new BidiagonalDecompositionRow_R64();
        }
