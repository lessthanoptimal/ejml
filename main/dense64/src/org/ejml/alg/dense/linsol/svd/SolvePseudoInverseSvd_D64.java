...
public class SolvePseudoInverseSvd_D64 implements LinearSolver<DenseMatrix64F> {
     ...
     */
    public SolvePseudoInverseSvd_D64(int maxRows, int maxCols) {

        svd = DecompositionFactory_D64.svd(maxRows,maxCols,true,true,true);
    }

    /**
     * Creates a solver targeted at matrices around 100x100
     */
    public SolvePseudoInverseSvd_D64() {
        this(100,100);
    }
