 ...
 * @author Peter Abeles
 */
public class SymmetricQrAlgorithm_R64 {
    ...
    public SymmetricQrAlgorithm_R64(SymmetricQREigenHelper_R64 helper ) {
        this.helper = helper;
    }
     ...
     */
    public SymmetricQrAlgorithm_R64() {
        this.helper = new SymmetricQREigenHelper_R64();
    }
    ...
    public boolean process( int sideLength,
        ...
        if( Q == null )
            Q = CommonOps_R64.identity(helper.N);
        helper.setQ(Q);
