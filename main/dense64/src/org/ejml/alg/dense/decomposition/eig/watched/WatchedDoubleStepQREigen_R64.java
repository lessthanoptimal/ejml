...
public class WatchedDoubleStepQREigen_R64 {
    ...
    private void performImplicitDoubleStep(int x1, int x2,
        ...
        // get rid of the bump
        if( Q != null ) {
            QrHelperFunctions_R64.rank1UpdateMultR(Q, u.data, gamma, 0, x1, x1 + 3, _temp.data);
            if( checkOrthogonal && !MatrixFeatures_R64.isOrthogonal(Q,UtilEjml.TEST_F64) ) {
                u.print();
        ...
        for( int i = x1; i < x2-2; i++ ) {
            if( bulgeDoubleStepQn(i) && Q != null ) {
                QrHelperFunctions_R64.rank1UpdateMultR(Q, u.data, gamma, 0, i + 1, i + 4, _temp.data);
                if( checkOrthogonal && !MatrixFeatures_R64.isOrthogonal(Q,UtilEjml.TEST_F64) )
                    throw new RuntimeException("Bad");
            }
        ...
        if( x2-2 >= 0 && bulgeSingleStepQn(x2-2) && Q != null ) {
            QrHelperFunctions_R64.rank1UpdateMultR(Q, u.data, gamma, 0, x2 - 1, x2 + 1, _temp.data);
            if( checkOrthogonal && !MatrixFeatures_R64.isOrthogonal(Q,UtilEjml.TEST_F64) )
                throw new RuntimeException("Bad");
...
//        A.print("%12.3e");
        ...
        if( checkHessenberg && !MatrixFeatures_R64.isUpperTriangle(A,1,UtilEjml.TEST_F64)) {
            A.print("%12.3e");
    ...
    public void performImplicitSingleStep(int x1, int x2 , double eigenvalue ) {
        ...
        // get rid of the bump
        if( Q != null ) {
            QrHelperFunctions_R64.rank1UpdateMultR(Q, u.data, gamma, 0, x1, x1 + 2, _temp.data);
            if( checkOrthogonal && !MatrixFeatures_R64.isOrthogonal(Q,UtilEjml.TEST_F64) )
                throw new RuntimeException("Bad");
        }
        ...
        for( int i = x1; i < x2-1; i++ ) {
            if( bulgeSingleStepQn(i) && Q != null ) {
                QrHelperFunctions_R64.rank1UpdateMultR(Q, u.data, gamma, 0, i + 1, i + 3, _temp.data);
                if( checkOrthogonal && !MatrixFeatures_R64.isOrthogonal(Q,UtilEjml.TESTP_F64) )
                    throw new RuntimeException("Bad");
            }
        ...
        if( checkHessenberg && !MatrixFeatures_R64.isUpperTriangle(A,1,UtilEjml.TESTP_F64)) {
            A.print("%12.3e");
            throw new RuntimeException("Bad matrix");
        }
    }
...
//           if( max <= Math.abs(A.get(i,i))*UtilEjml.EPS ) {
        ...
        QrHelperFunctions_R64.rank1UpdateMultR(A, u.data, gamma, 0, i, i + 3, _temp.data);
        ...
        QrHelperFunctions_R64.rank1UpdateMultL(A, u.data, gamma, 0, i, i + 3);

//        System.out.println("  after Q*A*Q ");
//        A.print();

        if(checkUncountable && MatrixFeatures_R64.hasUncountable(A)) {
            throw new RuntimeException("bad matrix");
        }
...
//                A.print();
        ...
        // apply Q*A  - just do the 3 rows
        QrHelperFunctions_R64.rank1UpdateMultR(A, u.data, gamma, 0, i, i + 2, _temp.data);
        ...
        // apply A*Q - just the three things
        QrHelperFunctions_R64.rank1UpdateMultL(A, u.data, gamma, 0, i, i + 2);
