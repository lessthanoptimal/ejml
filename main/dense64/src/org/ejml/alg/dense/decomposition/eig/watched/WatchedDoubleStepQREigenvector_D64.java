 ...
 * @author Peter Abeles
 */
public class WatchedDoubleStepQREigenvector_D64 {
...
//        A.print("%12.10f");
    ...
    private void solveUsingTriangle(double real, int index, RowMatrix_F64 r ) {
        ...
        SpecializedOps_D64.subvector(implicit.A,0,index,index,false,0,r);
        CommonOps_D64.changeSign(r);

        TriangularSolver_D64.solveU(implicit.A.data,r.data,implicit.A.numRows,0,index);
...
//                return false;
    ...
    public WatchedDoubleStepQREigen_D64 getImplicit() {
        return implicit;
    }
