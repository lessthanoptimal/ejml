 ...
 * @author Peter Abeles
 */
public class WatchedDoubleStepQREigenvector_R64 {
...
//        A.print("%12.10f");
    ...
    private void solveUsingTriangle(double real, int index, DMatrixRow_F64 r ) {
        ...
        SpecializedOps_R64.subvector(implicit.A,0,index,index,false,0,r);
        CommonOps_R64.changeSign(r);

        TriangularSolver_R64.solveU(implicit.A.data,r.data,implicit.A.numRows,0,index);
...
//                return false;
    ...
    public WatchedDoubleStepQREigen_R64 getImplicit() {
        return implicit;
    }
