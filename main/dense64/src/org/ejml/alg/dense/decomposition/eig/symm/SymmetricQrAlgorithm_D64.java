 ...
 * @author Peter Abeles
 */
public class SymmetricQrAlgorithm_D64 {
    ...
    public SymmetricQrAlgorithm_D64(SymmetricQREigenHelper_D64 helper ) {
        this.helper = helper;
    }
     ...
     */
    public SymmetricQrAlgorithm_D64() {
        this.helper = new SymmetricQREigenHelper_D64();
    }
    ...
    public boolean process( int sideLength,
        ...
        if( Q == null )
            Q = CommonOps_D64.identity(helper.N);
        helper.setQ(Q);
