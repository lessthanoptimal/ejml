 ...
 * </p>
 *
 * @see org.ejml.alg.dense.decomposition.lu.LUDecompositionAlt_R64
 *
 * @author Peter Abeles
 */
public class DeterminantFromMinor_R64 {
    ...
    private DMatrixRow_F64 tempMat;
     ...
     */
    public DeterminantFromMinor_R64(int width )
    {
        this(width,5);
    }
     ...
     */
    public DeterminantFromMinor_R64(int width , int minWidth )
    {
        ...
        tempMat = new DMatrixRow_F64(minWidth-1,minWidth-1);
    }
        ...
        while( true ) {
            ...
            if( levelIndex == levelWidth ) {
                ...
                if( levelWidth == minWidth ) {
                    ...
                    subresult *= UnrolledDeterminantFromMinor_R64.det(tempMat);
