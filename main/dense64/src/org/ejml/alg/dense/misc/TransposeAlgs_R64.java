 ...
 * @author Peter Abeles
 */
public class TransposeAlgs_R64 {
     ...
     */
    public static void square( D1MatrixRow_64 mat )
    {
        int index = 1;
     ...
     */
    public static void block(D1MatrixRow_64 A , D1MatrixRow_64 A_tran ,
...
//                    for( int k = 0; k < blockHeight; k++ , rowSrc += A.numCols ) {
     ...
     * @param A_tran Transposed matrix.  Modified.
     */
    public static void standard(D1MatrixRow_64 A, D1MatrixRow_64 A_tran)
    {
        int index = 0;
