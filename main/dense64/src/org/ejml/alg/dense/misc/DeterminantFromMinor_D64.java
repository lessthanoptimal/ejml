 ...
 * @author Peter Abeles
 */
public class DeterminantFromMinor_D64 {
     ...
     */
    public DeterminantFromMinor_D64(int width )
    {
        this(width,5);
    }
     ...
     */
    public DeterminantFromMinor_D64(int width , int minWidth )
    {
        ...
        while( true ) {
            ...
            if( levelIndex == levelWidth ) {
                ...
                if( levelWidth == minWidth ) {
                    ...
                    subresult *= UnrolledDeterminantFromMinor_D64.det(tempMat);
