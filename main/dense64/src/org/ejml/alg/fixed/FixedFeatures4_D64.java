...
public class FixedFeatures4_D64 {
    public static boolean isIdentical(FixedMatrix4x4_64F a , FixedMatrix4x4_64F b , double tol ) {
    ...
    public static boolean isIdentical(FixedMatrix4_64F a , FixedMatrix4_64F b , double tol ) {
    ...
    public static boolean hasUncountable(FixedMatrix4x4_64F a ) {
    ...
    public static boolean hasUncountable(FixedMatrix4_64F a ) {
