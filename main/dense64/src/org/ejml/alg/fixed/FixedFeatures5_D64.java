 ...
 * @author Peter Abeles
 */
public class FixedFeatures5_D64 {
    public static boolean isIdentical(FixedMatrix5x5_64F a , FixedMatrix5x5_64F b , double tol ) {
    ...
    public static boolean isIdentical(FixedMatrix5_64F a , FixedMatrix5_64F b , double tol ) {
    ...
    public static boolean hasUncountable(FixedMatrix5x5_64F a ) {
    ...
    public static boolean hasUncountable(FixedMatrix5_64F a ) {
