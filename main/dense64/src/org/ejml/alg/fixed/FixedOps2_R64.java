...
public class FixedOps2_R64 {
     ...
     */
    public static void add(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c ) {
        c.a11 = a.a11 + b.a11;
        c.a12 = a.a12 + b.a12;
        c.a21 = a.a21 + b.a21;
        c.a22 = a.a22 + b.a22;
     ...
     */
    public static void add(FixedMatrix2_F64 a , FixedMatrix2_F64 b , FixedMatrix2_F64 c ) {
        c.a1 = a.a1 + b.a1;
        c.a2 = a.a2 + b.a2;
    }
     ...
     * @param b A Matrix. Not modified.
     */
    public static void addEquals(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b ) {
        a.a11 += b.a11;
        a.a12 += b.a12;
        a.a21 += b.a21;
        a.a22 += b.a22;
     ...
     * @param b A Vector. Not modified.
     */
    public static void addEquals(FixedMatrix2_F64 a , FixedMatrix2_F64 b ) {
        a.a1 += b.a1;
        a.a2 += b.a2;
    }
     ...
     * @param c A Matrix where the results are stored. Modified.
     */
    public static void subtract(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c ) {
        c.a11 = a.a11 - b.a11;
        c.a12 = a.a12 - b.a12;
        c.a21 = a.a21 - b.a21;
        c.a22 = a.a22 - b.a22;
     ...
     * @param c A Vector where the results are stored. Modified.
     */
    public static void subtract(FixedMatrix2_F64 a , FixedMatrix2_F64 b , FixedMatrix2_F64 c ) {
        c.a1 = a.a1 - b.a1;
        c.a2 = a.a2 - b.a2;
    }
     ...
     * @param b A Matrix. Not modified.
     */
    public static void subtractEquals(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b ) {
        a.a11 -= b.a11;
        a.a12 -= b.a12;
        a.a21 -= b.a21;
        a.a22 -= b.a22;
     ...
     * @param b A Vector. Not modified.
     */
    public static void subtractEquals(FixedMatrix2_F64 a , FixedMatrix2_F64 b ) {
        a.a1 -= b.a1;
        a.a2 -= b.a2;
    }
     ...
     */
    public static void transpose( FixedMatrix2x2_F64 m ) {
        double tmp;
     ...
     */
    public static FixedMatrix2x2_F64 transpose(FixedMatrix2x2_F64 input , FixedMatrix2x2_F64 output ) {
        if( input == null )
            input = new FixedMatrix2x2_F64();
     ...
     */
    public static void mult(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c) {
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void multTransA(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c) {
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void multTransAB(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c) {
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void multTransB(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c) {
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void multAdd(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c) {
        c.a11 += a.a11*b.a11 + a.a12*b.a21;
        c.a12 += a.a11*b.a12 + a.a12*b.a22;
        c.a21 += a.a21*b.a11 + a.a22*b.a21;
        c.a22 += a.a21*b.a12 + a.a22*b.a22;
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void multAddTransA(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c) {
        c.a11 += a.a11*b.a11 + a.a21*b.a21;
        c.a12 += a.a11*b.a12 + a.a21*b.a22;
        c.a21 += a.a12*b.a11 + a.a22*b.a21;
        c.a22 += a.a12*b.a12 + a.a22*b.a22;
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void multAddTransAB(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c) {
        c.a11 += a.a11*b.a11 + a.a21*b.a12;
        c.a12 += a.a11*b.a21 + a.a21*b.a22;
        c.a21 += a.a12*b.a11 + a.a22*b.a12;
        c.a22 += a.a12*b.a21 + a.a22*b.a22;
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void multAddTransB(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c) {
        c.a11 += a.a11*b.a11 + a.a12*b.a12;
        c.a12 += a.a11*b.a21 + a.a12*b.a22;
        c.a21 += a.a21*b.a11 + a.a22*b.a12;
        c.a22 += a.a21*b.a21 + a.a22*b.a22;
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void mult(FixedMatrix2x2_F64 a , FixedMatrix2_F64 b , FixedMatrix2_F64 c) {
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void mult(FixedMatrix2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2_F64 c) {
     ...
     */
    public static double dot(FixedMatrix2_F64 a , FixedMatrix2_F64 b ) {
     ...
     * @param a A matrix.
     */
    public static void setIdentity( FixedMatrix2x2_F64 a ) {
        a.a11 = 1; a.a21 = 0;
        a.a12 = 0; a.a22 = 1;
    }
     ...
     */
    public static boolean invert(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 inv ) {
     ...
     */
    public static double det( FixedMatrix2x2_F64 mat ) {
     ...
     */
    public static double trace( FixedMatrix2x2_F64 a ) {
        return a.a11 + a.a21;
    }
     ...
     */
    public static void diag(FixedMatrix2x2_F64 input , FixedMatrix2_F64 out ) {
        out.a1 = input.a11;
        out.a2 = input.a22;
    }
     ...
     */
    public static double elementMaxAbs( FixedMatrix2x2_F64 a ) {
        double max = a.a11;
     ...
     */
    public static double elementMaxAbs( FixedMatrix2_F64 a ) {
        double max = a.a1;
     ...
     */
    public static double elementMin( FixedMatrix2x2_F64 a ) {
        double min = a.a11;
     ...
     */
    public static double elementMin( FixedMatrix2_F64 a ) {
        double min = a.a1;
     ...
     * @return The max element value of the matrix.
     */
    public static double elementMinAbs( FixedMatrix2x2_F64 a ) {
        double min = a.a11;
     ...
     */
    public static double elementMinAbs( FixedMatrix2_F64 a ) {
        double min = a.a1;
     ...
     * @param b The right matrix in the multiplication operation. Not modified.
     */
    public static void elementMult(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b) {
     ...
     * @param b The right vector in the multiplication operation. Not modified.
     */
    public static void elementMult(FixedMatrix2_F64 a , FixedMatrix2_F64 b) {
        a.a1 *= b.a1;
        a.a2 *= b.a2;
    }
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void elementMult(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c ) {
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void elementMult(FixedMatrix2_F64 a , FixedMatrix2_F64 b , FixedMatrix2_F64 c ) {
        c.a1 = a.a1*b.a1;
        c.a2 = a.a2*b.a2;
    }
     ...
     */
    public static void elementDiv(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b) {
        a.a11 /= b.a11; a.a12 /= b.a12;
        a.a21 /= b.a21; a.a22 /= b.a22;
    }
     ...
     */
    public static void elementDiv(FixedMatrix2_F64 a , FixedMatrix2_F64 b) {
        a.a1 /= b.a1;
        a.a2 /= b.a2;
    }
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void elementDiv(FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b , FixedMatrix2x2_F64 c ) {
        c.a11 = a.a11/b.a11; c.a12 = a.a12/b.a12;
        c.a21 = a.a21/b.a21; c.a22 = a.a22/b.a22;
    }
     ...
     * @param c Where the results of the operation are stored. Modified.
     */
    public static void elementDiv(FixedMatrix2_F64 a , FixedMatrix2_F64 b , FixedMatrix2_F64 c ) {
        c.a1 = a.a1/b.a1;
        c.a2 = a.a2/b.a2;
    }
     ...
     */
    public static void scale( double alpha , FixedMatrix2x2_F64 a ) {
     ...
     * @param alpha the amount each element is multiplied by.
     */
    public static void scale( double alpha , FixedMatrix2_F64 a ) {
        a.a1 *= alpha;
        a.a2 *= alpha;
    }
     ...
     */
    public static void scale(double alpha , FixedMatrix2x2_F64 a , FixedMatrix2x2_F64 b ) {
     ...
     * @param b Where the scaled matrix is stored. Modified.
     */
    public static void scale(double alpha , FixedMatrix2_F64 a , FixedMatrix2_F64 b ) {
        b.a1 = a.a1*alpha;
        b.a2 = a.a2*alpha;
    }
     ...
     */
    public static void divide(FixedMatrix2x2_F64 a , double alpha ) {
        a.a11 /= alpha; a.a12 /= alpha;
        a.a21 /= alpha; a.a22 /= alpha;
    }
     ...
     * @param alpha the amount each element is divided by.
     */
    public static void divide(FixedMatrix2_F64 a , double alpha ) {
        a.a1 /= alpha;
        a.a2 /= alpha;
    }
     ...
     */
    public static void divide(FixedMatrix2x2_F64 a , double alpha , FixedMatrix2x2_F64 b ) {
        b.a11 = a.a11/alpha; b.a12 = a.a12/alpha;
        b.a21 = a.a21/alpha; b.a22 = a.a22/alpha;
    }
     ...
     * @param b Where the results are stored. Modified.
     */
    public static void divide(FixedMatrix2_F64 a , double alpha , FixedMatrix2_F64 b ) {
        b.a1 = a.a1/alpha;
        b.a2 = a.a2/alpha;
    }
     ...
     * @param a A matrix. Modified.
     */
    public static void changeSign( FixedMatrix2x2_F64 a )
    {
     ...
     * @param a A vector. Modified.
     */
    public static void changeSign( FixedMatrix2_F64 a )
    {
        a.a1 = -a.a1;
        a.a2 = -a.a2;
    }
     ...
     */
    public static void fill(FixedMatrix2x2_F64 a , double v  ) {
        a.a11 = v; a.a12 = v;
        a.a21 = v; a.a22 = v;
    }
     ...
     * @param v The value each element will have.
     */
    public static void fill(FixedMatrix2_F64 a , double v  ) {
        a.a1 = v;
        a.a2 = v;
    }
     ...
     */
    public static FixedMatrix2_F64 extractRow(FixedMatrix2x2_F64 a , int row , FixedMatrix2_F64 out ) {
        if( out == null) out = new FixedMatrix2_F64();
        switch( row ) {
            case 0:
                out.a1 = a.a11;
                out.a2 = a.a12;
     ...
     */
    public static FixedMatrix2_F64 extractColumn(FixedMatrix2x2_F64 a , int column , FixedMatrix2_F64 out ) {
        if( out == null) out = new FixedMatrix2_F64();
        switch( column ) {
            case 0:
                out.a1 = a.a11;
