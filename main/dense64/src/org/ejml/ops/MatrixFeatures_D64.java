 ...
 * @author Peter Abeles
 */
public class MatrixFeatures_D64 {
    ...
    public static boolean isSymmetric(RowMatrix_F64 m , double tol ) {
        ...
        double max = CommonOps_D64.elementMaxAbs(m);
    ...
    public static int rank(RowMatrix_F64 A , double threshold ) {
        ...
        return SingularOps_D64.rank(svd, threshold);
    }
    ...
    public static int nullity(RowMatrix_F64 A , double threshold ) {
        ...
        return SingularOps_D64.nullity(svd,threshold);
    }
}
