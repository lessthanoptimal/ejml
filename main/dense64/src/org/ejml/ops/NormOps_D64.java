...
public class NormOps_D64 {
    ...
    public static double conditionP(RowMatrix_F64 A , double p )
    {
        if( p == 2 ) {
            ...
            if( !CommonOps_D64.invert(A,A_inv) )
    ...
    public static double conditionP2( RowMatrix_F64 A )
    {
        ...
        int n = SingularOps_D64.rank(svd,UtilEjml.TEST_F64);
     ...
     */
    public static double fastNormF( D1Matrix_F64 a ) {
        double total = 0;
     ...
     */
    public static double normF( D1Matrix_F64 a ) {
        double total = 0;

        double scale = CommonOps_D64.elementMaxAbs(a);
    ...
    public static double elementP(RowD1Matrix_F64 A , double p ) {
        if( p == 1 ) {
            return CommonOps_D64.elementSumAbs(A);
        } if( p == 2 ) {
            return normF(A);
        } else {
            double max = CommonOps_D64.elementMaxAbs(A);
     ...
     * @return The norm's value.
     */
    public static double fastElementP(D1Matrix_F64 A , double p ) {
        if( p == 2 ) {
            return fastNormF(A);
        } else {
            double total = 0;
    ...
    public static double normP(RowMatrix_F64 A , double p ) {
        ...
        if( MatrixFeatures_D64.isVector(A) ) {
            return elementP(A,p);
        } else {
    ...
    public static double normPInf( RowMatrix_F64 A ) {
        if( MatrixFeatures_D64.isVector(A)) {
            return CommonOps_D64.elementMaxAbs(A);
        } else {
