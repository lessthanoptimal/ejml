...
public class CommonOps_D64 {
     ...
     * vectors there is an even faster option, see {@link VectorVectorMult_D64#innerProd(org.ejml.data.D1Matrix64F, org.ejml.data.D1Matrix64F)}
     * </p>
     *
                                ...
                                int dstY0, int dstX0 )
    {
        ...
        if( src instanceof DenseMatrix64F && dst instanceof DenseMatrix64F ) {
            ImplCommonOps_D64.extract((DenseMatrix64F)src,srcY0,srcX0,(DenseMatrix64F)dst,dstY0,dstX0, h, w);
        } else {
    ...
    public static DenseMatrix64F rref( DenseMatrix64F A , int numUnknowns, DenseMatrix64F reduced ) {
        ...
        ReducedRowEchelonForm_F64<DenseMatrix64F> alg = new RrefGaussJordanRowPivot_D64();
