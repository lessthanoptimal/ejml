 ...
 * @author Peter Abeles
 */
public class GenericSolvePseudoInverseChecks_R64 {
    ...
    public void underDetermined_wide_solve() {
        ...
        assertTrue(MatrixFeatures_R64.isEquals(y, found, UtilEjml.TEST_F64));
    }
    ...
    public void underDetermined_wide_inv() {
        ...
        assertTrue(MatrixFeatures_R64.isEquals(x, found,UtilEjml.TEST_F64));
    }
