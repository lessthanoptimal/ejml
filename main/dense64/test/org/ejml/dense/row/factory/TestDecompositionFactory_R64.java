 ...
 * @author Peter Abeles
 */
public class TestDecompositionFactory_R64 {
    ...
    public void quality_eig() {
        ...
        double origQuality = DecompositionFactory_R64.quality(A,eig);

        // Mess up the EVD so that it will be of poor quality
        eig.getEigenVector(2).set(2,0,5);

        double modQuality = DecompositionFactory_R64.quality(A,eig);
    ...
    public void quality_svd() {
        ...
        double origQuality = DecompositionFactory_R64.quality(A,svd);

        // Mess up the SVD so that it will be of poor quality
        svd.getSingularValues()[2] = 5;

        double modQuality = DecompositionFactory_R64.quality(A,svd);
