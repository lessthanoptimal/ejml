...
public abstract class GenericLinearSolverChecks_D64 {
    ...
    public void solve_dimensionCheck() {
        ...
        try {
            RowMatrix_F64 x = RandomMatrices_D64.createRandom(4,2,rand);
            RowMatrix_F64 b = RandomMatrices_D64.createRandom(9,2,rand);
            solver.solve(b,x);
        ...
        try {
            ...
            RowMatrix_F64 b = RandomMatrices_D64.createRandom(10,2,rand);
            solver.solve(b,x);
            fail("Should have thrown an exception");
        } catch( RuntimeException ignore ) {}
        ...
        try {
            RowMatrix_F64 x = RandomMatrices_D64.createRandom(4,2,rand);
            RowMatrix_F64 b = RandomMatrices_D64.createRandom(10,1,rand);
            solver.solve(b,x);
            fail("Should have thrown an exception");
        } catch( RuntimeException ignore ) {}
    }
    ...
    public void modifiesA() {
        RowMatrix_F64 A_orig = RandomMatrices_D64.createRandom(4,4,rand);
    ...
    public void checkQuality() {
        RowMatrix_F64 A_good = CommonOps_D64.diag(4,3,2,1);
        RowMatrix_F64 A_bad = CommonOps_D64.diag(4, 3, 2, 0.1);
    ...
    public void checkQuality_scale() {
        RowMatrix_F64 A = CommonOps_D64.diag(4,3,2,1);
