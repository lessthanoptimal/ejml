...
public class TestAdjLinearSolverQr_D64 extends GenericLinearSolverChecks_D64 {
    ...
    public void addRowToA() {
        ...
        RowMatrix_F64 X = RandomMatrices_D64.createRandom(n,2,rand);
        ...
        RowMatrix_F64 X_found = RandomMatrices_D64.createRandom(X.numRows,X.numCols,rand);
        adjSolver.solve(Y,X_found);

        // see if they produce the same results
        assertTrue(MatrixFeatures_D64.isIdentical(X_found,X, UtilEjml.TEST_F64));
    }
