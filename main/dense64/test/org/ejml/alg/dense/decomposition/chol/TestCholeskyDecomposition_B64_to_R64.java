 ...
 * @author Peter Abeles
 */
public class TestCholeskyDecomposition_B64_to_R64 extends GenericCholeskyTests_R64 {
    @Test
    public void checkModifyInput() {
        checkModifiedInput(new CholeskyDecomposition_B64_to_R64(true));
        checkModifiedInput(new CholeskyDecomposition_B64_to_R64(false));
    }
