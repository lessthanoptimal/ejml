 ...
 * @author Peter Abeles
 */
public class TestSymmetricQRAlgorithmDecomposition_R64 extends GeneralEigenDecompositionCheck_R64 {
    boolean together;

    @Override
    public EigenDecomposition_F64 createDecomposition() {
        SymmetricQRAlgorithmDecomposition_R64 alg = new SymmetricQRAlgorithmDecomposition_R64(computeVectors);
        if( computeVectors )
