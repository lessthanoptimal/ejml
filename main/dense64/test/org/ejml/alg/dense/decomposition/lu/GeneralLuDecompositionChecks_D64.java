...
public abstract class GeneralLuDecompositionChecks_D64 {
    ...
    public abstract LUDecomposition<RowMatrix_F64> create(int numRows , int numCols );
    ...
    public void testDecomposition()
    {
        ...
        RowMatrix_F64 octLower = new RowMatrix_F64(3,3, true, 1, 0, 0, -0.6, 1, 0, 0.3, -0.44068, 1);
        RowMatrix_F64 octUpper = new RowMatrix_F64(3,3, true, 5, 2, 3, 0, 5.9, 1.3, 0, 0, 7.67288);

        LUDecomposition<RowMatrix_F64> alg = create(3,3);
        ...
        RowMatrix_F64 A_found = P.mult(L).mult(U).getMatrix();
        assertTrue(MatrixFeatures_D64.isIdentical(A_found,A,UtilEjml.TEST_F64));
    }
    ...
    {
        for( int i = 2; i <= 20; i++ ) {
            RowMatrix_F64 A = RandomMatrices_D64.createRandom(i,i,-1,1,rand);

            LUDecomposition<RowMatrix_F64> alg = create(i,i);
            assertTrue(alg.decompose(A));
            ...
            RowMatrix_F64 A_found = P.transpose().mult(L).mult(U).getMatrix();
            assertTrue(MatrixFeatures_D64.isIdentical(A_found,A,UtilEjml.TEST_F64));
        }
    }
    ...
    public void zeroMatrix() {
        ...
        RowMatrix_F64 L = alg.getLower(null);
        RowMatrix_F64 U = alg.getUpper(null);

        RowMatrix_F64 A_found = new RowMatrix_F64(3,3);
    ...
    public void testSingular(){
        RowMatrix_F64 A = new RowMatrix_F64(3,3, true, 1, 2, 3, 2, 4, 6, 4, 4, 0);
    ...
    public void testNearlySingular(){
        RowMatrix_F64 A = new RowMatrix_F64(3,3, true, 1, 2, 3, 2, 4, 6.1, 4, 4, 0);
    ...
    public void getLower_getUpper() {
        ...
        RowMatrix_F64 L_provided = RandomMatrices_D64.createRandom(3,3,rand);
        RowMatrix_F64 U_provided = RandomMatrices_D64.createRandom(3,3,rand);

        assertTrue(L_provided == alg.getLower(L_provided));
        assertTrue(U_provided == alg.getUpper(U_provided));

        RowMatrix_F64 L_ret = alg.getLower(null);
        RowMatrix_F64 U_ret = alg.getUpper(null);
    ...
    @Test
    public void testFat() {
        RowMatrix_F64 A = new RowMatrix_F64(2,3, true, 1, 2, 3, 2, 4, 6.1);

        LUDecomposition<RowMatrix_F64> alg = create(2,3);
...
//        assertFalse(alg.isSingular());
    ...
    public void testTall() {
        RowMatrix_F64 A = new RowMatrix_F64(3,2, true, 1, 2, 3, 2, 4, 6.1);

        LUDecomposition<RowMatrix_F64> alg = create(3,2);
