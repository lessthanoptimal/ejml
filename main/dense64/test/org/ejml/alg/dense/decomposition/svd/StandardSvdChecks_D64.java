...
public abstract class StandardSvdChecks_D64 {
    ...
    public abstract SingularValueDecomposition_F64<DenseMatrix64F> createSvd();
    ...
    public void testWide() {
        DenseMatrix64F A = RandomMatrices_D64.createRandom(5,20,-1,1,rand);
    ...
    public void testTall() {
        DenseMatrix64F A = RandomMatrices_D64.createRandom(21,5,-1,1,rand);
    ...
    public void testIdentity() {
        DenseMatrix64F A = CommonOps_D64.identity(6,6);
    ...
    public void testLarger() {
        DenseMatrix64F A = RandomMatrices_D64.createRandom(200,200,-1,1,rand);
    ...
    public void testLots() {
        ...
        for( int i = 1; i < 10; i++ ) {
            for( int j = 1; j < 10; j++ ) {
                DenseMatrix64F A = RandomMatrices_D64.createRandom(i,j,-1,1,rand);
    ...
    public void checkGetU_Transpose() {
        DenseMatrix64F A = RandomMatrices_D64.createRandom(5, 7, -1, 1, rand);
    ...
    private int checkOccurrence( double check , double[]values , int numSingular ) {
        ...
        for( int i = 0; i < numSingular; i++ ) {
            if( Math.abs(values[i]-check)<UtilEjml.TEST_64F)
                num++;
        }
