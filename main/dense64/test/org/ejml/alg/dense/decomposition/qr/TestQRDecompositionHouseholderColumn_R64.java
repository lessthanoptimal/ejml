 ...
 * @author Peter Abeles
 */
public class TestQRDecompositionHouseholderColumn_R64 extends GenericQrCheck_R64 {
    ...
    private void checkSubMatrix(int width , int w ) {
        ...
        qr.convertToColumnMajor((DMatrixRow_F64)A.getMatrix());
    ...
    private static class DebugQR extends QRDecompositionHouseholderColumn_R64
    {
