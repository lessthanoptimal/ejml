...
//            System.out.println("Function = "+name+"  alpha = "+hasAlpha);
    ...
    private boolean checkMultMethod(Method method, Method checkMethod, boolean hasAlpha,
        ...
        for( int i = 1; i < 40; i++ ) {
            ...
            RowMatrix_F64 c = RandomMatrices_D64.createRandom(i,i,rand);
        ...
        for( int i = 1; i < 4; i++ ) {
            ...
            RowMatrix_F64 c = RandomMatrices_D64.createRandom(i+1,1,rand);
            RowMatrix_F64 c_alt = c.copy();
    ...
    private boolean checkMultMethod(Method method, int rowsA , int colsA , int rowsB , int colsB ) throws InvocationTargetException, IllegalAccessException {
        ...
        if( add ) {
            ...
            assertTrue(MatrixFeatures_D64.isIdentical(corig, c, UtilEjml.TEST_F64));
        } else {
    ...
    @Test
    public void dot() {
        RowMatrix_F64 a = RandomMatrices_D64.createRandom(10, 1, rand);
        RowMatrix_F64 b = RandomMatrices_D64.createRandom(1,10,rand);
    ...
    public void multInner() {
        RowMatrix_F64 a = RandomMatrices_D64.createRandom(10,4,rand);
        RowMatrix_F64 found = RandomMatrices_D64.createRandom(4,4,rand);
        RowMatrix_F64 expected = RandomMatrices_D64.createRandom(4, 4, rand);
    ...
    public void multOuter() {
        RowMatrix_F64 a = RandomMatrices_D64.createRandom(10,4,rand);
        RowMatrix_F64 found = RandomMatrices_D64.createRandom(10,10,rand);
        RowMatrix_F64 expected = RandomMatrices_D64.createRandom(10,10,rand);
    ...
    public void elementMult_two() {
        ...
        RowMatrix_F64 b = RandomMatrices_D64.createRandom(5,4,rand);
    ...
    public void elementMult_three() {
        RowMatrix_F64 a = RandomMatrices_D64.createRandom(5,4,rand);
        RowMatrix_F64 b = RandomMatrices_D64.createRandom(5,4,rand);
        RowMatrix_F64 c = RandomMatrices_D64.createRandom(5, 4, rand);
    ...
    public void solve() {
        ...
        RowMatrix_F64 b = RandomMatrices_D64.createRandom(2,5,rand);
        RowMatrix_F64 c = RandomMatrices_D64.createRandom(2,5,rand);
        RowMatrix_F64 c_exp = RandomMatrices_D64.createRandom(2,5,rand);
    ...
    public void trace() {
        ...
        // non square
        RowMatrix_F64 B = RandomMatrices_D64.createRandom(4,3,rand);
    ...
    public void pinv() {
        ...
        assertTrue(MatrixFeatures_D64.isIdentical(b,found,UtilEjml.TEST_F64_SQ));
    ...
    public void columnsToVectors() {
        RowMatrix_F64 M = RandomMatrices_D64.createRandom(4, 5, rand);

        RowMatrix_F64 v[] = CommonOps_D64.columnsToVector(M, null);
    ...
    public void identity() {
        RowMatrix_F64 A = CommonOps_D64.identity(4);

        assertEquals(4,A.numRows);
        assertEquals(4,A.numCols);

        assertEquals(4, CommonOps_D64.elementSum(A),UtilEjml.TEST_F64);
    }

    @Test
    public void identity_rect() {
        RowMatrix_F64 A = CommonOps_D64.identity(4, 6);
    ...
    @Test
    public void diag() {
        RowMatrix_F64 A = CommonOps_D64.diag(2.0, 3.0, 6.0, 7.0);
        ...
        assertEquals(18, CommonOps_D64.elementSum(A),UtilEjml.TEST_F64);
    }

    @Test
    public void diag_rect() {
        RowMatrix_F64 A = CommonOps_D64.diagR(4, 6, 2.0, 3.0, 6.0, 7.0);
    ...
    public void kron() {
        ...
        assertTrue(MatrixFeatures_D64.isIdentical(C, C_expected, UtilEjml.TEST_F64));
    ...
    public void extract_ret() {
        ...
        RowMatrix_F64 B = CommonOps_D64.extract(A,1,3,2,5);
    ...
    public void insert_array_two() {
        RowMatrix_F64 A = RandomMatrices_D64.createRandom(2,1, 0, 1, rand);
    ...
    public void extractDiag() {
        RowMatrix_F64 a = RandomMatrices_D64.createRandom(3,4, 0, 1, rand);
    ...
    public void extractRow() {
        RowMatrix_F64 A = RandomMatrices_D64.createRandom(5,6, 0, 1, rand);

        RowMatrix_F64 B = CommonOps_D64.extractRow(A, 3, null);
    ...
    public void extractColumn() {
        ...
        RowMatrix_F64 B = CommonOps_D64.extractColumn(A, 3, null);
   ...
   @Test
    ...
    public void add() {
        RowMatrix_F64 a = new RowMatrix_F64(2,3, true, 0, 1, 2, 3, 4, 5);
        RowMatrix_F64 b = new RowMatrix_F64(2,3, true, 5, 4, 3, 2, 1, 0);
        RowMatrix_F64 c = RandomMatrices_D64.createRandom(2,3,rand);
    ...
    public void changeSign_one() {
        RowMatrix_F64 A = RandomMatrices_D64.createRandom(2,3,rand);
        RowMatrix_F64 A_orig = A.copy();
    ...
    public void changeSign_two() {
        RowMatrix_F64 A = RandomMatrices_D64.createRandom(2,3,rand);
        RowMatrix_F64 B = RandomMatrices_D64.createRandom(2, 3, rand);
    ...
    public void elementSum() {
        RowMatrix_F64 M = RandomMatrices_D64.createRandom(5,5,rand);
        ...
        assertEquals(sum, CommonOps_D64.elementSum(M),UtilEjml.TEST_F64);
    }
    ...
    public void elementPower_mm() {
        ...
        RowMatrix_F64 B = RandomMatrices_D64.createRandom(4, 5, rand);
        RowMatrix_F64 C = RandomMatrices_D64.createRandom(4, 5, rand);
    ...
    @Test
    public void sumRows() {
        RowMatrix_F64 input = RandomMatrices_D64.createRandom(4,5,rand);
        ...
        RowMatrix_F64 output2 = CommonOps_D64.sumRows(input, null);
    ...
    public void sumCols() {
        ...
        // check with a null output
        RowMatrix_F64 output2 = CommonOps_D64.sumCols(input, null);
    ...
    public void rref() {
        ...
        RowMatrix_F64 found = CommonOps_D64.rref(A, 5, null);
    ...
    public void elements() {
        ...
        RowMatrix_B B = RandomMatrices_D64.createRandomB(3, 4, rand);

        RowMatrix_F64 found = CommonOps_D64.elements(A, B, null);
    ...
    public void countTrue() {
        RowMatrix_B B = RandomMatrices_D64.createRandomB(4, 5, rand);
