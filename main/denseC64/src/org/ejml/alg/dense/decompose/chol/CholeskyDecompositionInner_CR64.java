 ...
 * @author Peter Abeles
 */
public class CholeskyDecompositionInner_CR64 extends CholeskyDecompositionCommon_CR64 {

    // tolerance for testing to see if diagonal elements are real
    double tolerance = UtilEjml.EPS;

    public CholeskyDecompositionInner_CR64() {
        super(true);
    }

    public CholeskyDecompositionInner_CR64(boolean lower) {
        super(lower);
    }
