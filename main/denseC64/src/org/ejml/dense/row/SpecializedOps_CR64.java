...
import org.ejml.dense.row.mult.VectorVectorMult_CR64;

/**
 * @author Peter Abeles
 */
public class SpecializedOps_CR64 {
    ...
    public static DMatrixRow_C64 householderVector(DMatrixRow_C64 x ) {
        ...
        CommonOps_CR64.elementDivide(u, max, 0, u);

        double nx = NormOps_CR64.normF(u);
        ...
        CommonOps_CR64.elementDivide(u,u.getReal(0,0),u.getImag(0,0),u);
