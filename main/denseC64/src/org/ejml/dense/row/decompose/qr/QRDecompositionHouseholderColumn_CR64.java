 ...
 * </p>
 *
 * @see QRDecompositionHouseholder_CR64
 *
 * @author Peter Abeles
 */
public class QRDecompositionHouseholderColumn_CR64 implements QRDecomposition<DMatrixRow_C64> {
    ...
    public DMatrixRow_C64 getQ(DMatrixRow_C64 Q , boolean compact ) {
        ...
        for( int j = minLength-1; j >= 0; j-- ) {
            ...
            QrHelperFunctions_CR64.rank1UpdateMultR(Q, u,0, gammaReal,j, j, numRows, v);
    ...
    protected void householder( int j )
    {
        ...
        final double max = QrHelperFunctions_CR64.findMax(u, j, numRows - j);
        ...
        if( max == 0.0 ) {
            ...
            gamma = QrHelperFunctions_CR64.computeTauGammaAndDivide(j, numRows, u, max, tau);
