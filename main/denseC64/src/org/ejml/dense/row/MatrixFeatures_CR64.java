...
public class MatrixFeatures_CR64 {
    ...
    public static boolean isUnitary(DMatrixRow_C64 Q , double tol ) {
        ...
        for( int i = 0; i < u.length; i++ ) {
            ...
            for( int j = i+1; j < u.length; j++ ) {
                VectorVectorMult_CR64.innerProdH(a, u[j], prod);
    ...
    public static boolean isPositiveDefinite( DMatrixRow_C64 A ) {
        ...
        CholeskyDecompositionInner_CR64 chol = new CholeskyDecompositionInner_CR64(true);
