...
import org.ejml.dense.row.decompose.qr.QRDecompositionHouseholder_CR64;
 ...
 * @author Peter Abeles
 */
public class LinearSolverQrHouse_CR64 extends LinearSolverAbstract_CR64 {

    private QRDecompositionHouseholder_CR64 decomposer;
     ...
     */
    public LinearSolverQrHouse_CR64() {
        decomposer = new QRDecompositionHouseholder_CR64();
    ...
    public void solve(DMatrixRow_C64 B, DMatrixRow_C64 X) {
        ...
        for( int colB = 0; colB < BnumCols; colB++ ) {
            ...
            TriangularSolver_CR64.solveU(QR.data, a, numCols);
