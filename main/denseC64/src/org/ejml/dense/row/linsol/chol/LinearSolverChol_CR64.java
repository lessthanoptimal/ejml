...
import org.ejml.dense.row.decompose.chol.CholeskyDecompositionCommon_CR64;
...
* @author Peter Abeles
*/
public class LinearSolverChol_CR64 extends LinearSolverAbstract_CR64 {

    CholeskyDecompositionCommon_CR64 decomposer;
    int n;
    double vv[] = new double[0];
    double t[];

    public LinearSolverChol_CR64(CholeskyDecompositionCommon_CR64 decomposer) {
    ...
    public /**/double quality() {
        return SpecializedOps_CR64.qualityTriangular(decomposer._getT());
    }
    ...
    private void solveInternalL() {
        ...
        TriangularSolver_CR64.solveL_diagReal(t, vv, n);

        // solve L^T*x=y
        TriangularSolver_CR64.solveConjTranL_diagReal(t, vv, n);
    }
