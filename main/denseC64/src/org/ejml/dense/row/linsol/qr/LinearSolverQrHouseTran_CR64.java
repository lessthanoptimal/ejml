...
import org.ejml.dense.row.decompose.qr.QRDecompositionHouseholderTran_CR64;
import org.ejml.dense.row.linsol.LinearSolverAbstract_CR64;
 ...
 * @author Peter Abeles
 */
public class LinearSolverQrHouseTran_CR64 extends LinearSolverAbstract_CR64 {

    private QRDecompositionHouseholderTran_CR64 decomposer;
    ...
    private DMatrixRow_C64 QR; // a column major QR matrix
    private DMatrixRow_C64 U;

    /**
     * Creates a linear solver that uses QR decomposition.
     */
    public LinearSolverQrHouseTran_CR64() {
        decomposer = new QRDecompositionHouseholderTran_CR64();
    }
    ...
    public /**/double quality() {
        ...
        // elements
        return SpecializedOps_CR64.qualityTriangular(QR);
    }
    ...
    public void solve(DMatrixRow_C64 B, DMatrixRow_C64 X) {
        ...
        for( int colB = 0; colB < BnumCols; colB++ ) {
            ...
            TriangularSolver_CR64.solveU(U.data, a, numCols);
