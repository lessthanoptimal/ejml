...
//        LinearSolver<CDenseMatrix64F> solver = createSafeSolver();
//
//        CDenseMatrix64F A = new CDenseMatrix64F(3,3, true, 1, 2, 4, 2, 13, 23, 4, 23, 90);
//        CDenseMatrix64F b = new CDenseMatrix64F(3,1, true, 17, 97, 320);
...
//        LinearSolver<CDenseMatrix64F> solver = createSafeSolver();
//
//        CDenseMatrix64F A = CCommonOps.diag(3, 2, 1);
//        CDenseMatrix64F B = CCommonOps.diag(3,2,0.001);
//
//        assertTrue(solver.setA(A));
