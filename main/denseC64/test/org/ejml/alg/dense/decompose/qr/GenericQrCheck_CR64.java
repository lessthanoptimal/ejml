...
public abstract class GenericQrCheck_CR64 {
    ...
    public void testModifiedInput() {
        ...
        RowMatrix_C64 A = RandomMatrices_CR64.createRandom(6, 4, rand);
    ...
    private void checkDecomposition(int height, int width, boolean compact ) {
        ...
        RowMatrix_C64 A = RandomMatrices_CR64.createRandom(height,width,rand);
    ...
    public void checkGetNullVersusNot() {
        ...
        RowMatrix_C64 Q_provided = RandomMatrices_CR64.createRandom(height,height,rand);
        RowMatrix_C64 R_provided = RandomMatrices_CR64.createRandom(height,width,rand);
