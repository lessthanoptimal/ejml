...
public class TestUtilDecompositons_CD64 {
    ...
    public void checkIdentity_null() {
        ...
        assertTrue(CMatrixFeatures.isIdentity(A, 1e-8));
    }
    ...
    public void checkZeros_null() {
        ...
        assertTrue(CMatrixFeatures.isZeros(A, 1e-8));
    }
    ...
    public void checkZerosLT_null() {
        ...
        assertTrue(CMatrixFeatures.isUpperTriangle(A,0, 1e-8));
    }
    ...
    public void checkZerosUT_null() {
        ...
        assertTrue(CMatrixFeatures.isLowerTriangle(A,0, 1e-8));
    }
