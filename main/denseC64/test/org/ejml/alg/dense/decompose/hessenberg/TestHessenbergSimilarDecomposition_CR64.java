...
public class TestHessenbergSimilarDecomposition_CR64 {
...
//        UtilEjml.print(H,"%8.2e");
        ...
        assertTrue(!MatrixFeatures_CR64.hasUncountable(H));

        assertTrue(MatrixFeatures_CR64.isIdentical(A,H,UtilEjml.TEST_F64));
    }
    ...
    public void testInputUnmodified() {
        ...
        assertTrue(MatrixFeatures_CR64.isIdentical(A,B,0));
    }
...
//        UtilEjml.print(foundH);
        ...
        assertTrue(MatrixFeatures_CR64.isIdentical(expectedH,foundH,UtilEjml.TEST_F64));
    }
}
