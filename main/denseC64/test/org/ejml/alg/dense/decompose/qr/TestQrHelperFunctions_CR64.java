 ...
 * @author Peter Abeles
 */
public class TestQrHelperFunctions_CR64 {
    ...
    public void findMax() {
        ...
        assertEquals(max,QrHelperFunctions_CR64.findMax(u,offset,length),UtilEjml.TEST_F64);
    }
    ...
    public void divideElements_startU() {
        ...
        QrHelperFunctions_CR64.divideElements(j,numRows,found,startU,A.real,A.imaginary);
    ...
    public void computeTauGammaAndDivide() {
        ...
        double foundGamma = QrHelperFunctions_CR64.computeTauGammaAndDivide(j,numRows,foundU,max,foundTau);
    ...
    public void extractHouseholderColumn() {
        ...
        QrHelperFunctions_CR64.extractHouseholderColumn(A,1,5,1,u,1);
    ...
    public void extractHouseholderRow() {
        ...
        QrHelperFunctions_CR64.extractHouseholderRow(A,1,1,5,u,1);
    ...
    public void extractColumnAndMax() {
        ...
        double u[] = new double[6*2];
        double max = QrHelperFunctions_CR64.extractColumnAndMax(A,1,5,1,u,1);
    ...
    public void computeRowMax() {
        ...
        double max = QrHelperFunctions_CR64.computeRowMax(A,1,1,5);
