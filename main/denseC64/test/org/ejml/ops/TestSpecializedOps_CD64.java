...
public class TestSpecializedOps_CD64 {
    ...
    public void createReflector() {
        RowMatrix_C64 u = RandomMatrices_CD64.createRandom(4,1,rand);

        RowMatrix_C64 Q = SpecializedOps_CD64.createReflector(u);
        ...
        assertTrue(MatrixFeatures_CD64.isNegative(u,w,UtilEjml.TEST_F64));
    }
    ...
    public void createReflector_gamma() {
        ...
        RowMatrix_C64 Q = SpecializedOps_CD64.createReflector(u,gamma);
    ...
    public void pivotMatrix() {
        ...
        RowMatrix_C64 P = SpecializedOps_CD64.pivotMatrix(null,pivots,4,false);
        RowMatrix_C64 Pt = SpecializedOps_CD64.pivotMatrix(null,pivots,4,true);
        ...
        assertTrue(MatrixFeatures_CD64.isIdentical(B, Pt, UtilEjml.TEST_F64));
    }
    ...
    public void householder() {
        RowMatrix_C64 U = RandomMatrices_CD64.createRandom(6,1,rand);
        double gamma = 1.6;

        // Q = I - gamma*U*U^H
        RowMatrix_C64 I = CommonOps_CD64.identity(6);
        ...
        RowMatrix_C64 found = SpecializedOps_CD64.householder(U,gamma);

        assertTrue(MatrixFeatures_CD64.isIdentical(expected,found,UtilEjml.TEST_F64));
    }

    @Test
    public void householderVector() {
        RowMatrix_C64 x = RandomMatrices_CD64.createRandom(6, 1, rand);

//        x.set(0,0,0,0);

        RowMatrix_C64 u = SpecializedOps_CD64.householderVector(x);
        double gamma = 2.0/(double)Math.pow(NormOps_CD64.normF(u), 2.0);

        // Q = I - gamma*U*U^H
        RowMatrix_C64 Q = CommonOps_CD64.identity(6);
