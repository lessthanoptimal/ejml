...
import org.ejml.ops.FBinaryOperator;
import org.ejml.ops.FUnaryOperator;
...
public class CommonOps_FSCC {
    ...
    public static FMatrixSparseCSC mult(FMatrixSparseCSC A , FMatrixSparseCSC B , FMatrixSparseCSC output ) {
                                        ...
                                        IGrowArray gw, FGrowArray gx )
    {
        ...
        ImplSparseSparseMult_FSCC.mult(A,B,output, gw, gx);

        return output;
    }

    public static FMatrixSparseCSC multTransA(FMatrixSparseCSC A , FMatrixSparseCSC B , FMatrixSparseCSC output ,
                                              IGrowArray gw, FGrowArray gx )
    {
        ...
        ImplSparseSparseMult_FSCC.multTransA(A,B,output,gw,gx);
     ...
     * @param gx (Optional) Storage for internal workspace.  Can be null.
     */
    public static FMatrixSparseCSC multTransB(FMatrixSparseCSC A , FMatrixSparseCSC B ,
                                              ...
                                              IGrowArray gw, FGrowArray gx )
    {
        ...
        ImplSparseSparseMult_FSCC.multTransB(A,B,output,gw,gx);
     ...
     */
    public static FMatrixRMaj mult(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj output )
    {
        if( A.numCols != B.numRows )
            throw new MatrixDimensionException("Inconsistent matrix shapes. "+stringShapes(A,B));
        output = reshapeOrDeclare(output,A.numRows,B.numCols);

        ImplSparseSparseMult_FSCC.mult(A,B,output);
     ...
     * <p>C = C + A*B</p>
     */
    public static void multAdd(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj output )
    {
        if( A.numCols != B.numRows )
            throw new MatrixDimensionException("Inconsistent matrix shapes. "+stringShapes(A,B));
        ...
        ImplSparseSparseMult_FSCC.multAdd(A,B,output);
    }
     ...
     * @param output Dense Matrix
     */
    public static FMatrixRMaj multTransA(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj output )
    {
        if( A.numRows != B.numRows )
            throw new MatrixDimensionException("Inconsistent matrix shapes. "+stringShapes(A,B));
        ...
        ImplSparseSparseMult_FSCC.multTransA(A,B,output);
     ...
     */
    public static void multAddTransA(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj output )
    {
        if( A.numRows != B.numRows )
            throw new MatrixDimensionException("Inconsistent matrix shapes. "+stringShapes(A,B));
        ...
        ImplSparseSparseMult_FSCC.multAddTransA(A,B,output);
    }
     ...
     * @param output Dense Matrix
     */
    public static FMatrixRMaj multTransB(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj output )
    {
        if( A.numCols != B.numCols )
            throw new MatrixDimensionException("Inconsistent matrix shapes. "+stringShapes(A,B));
        output = reshapeOrDeclare(output,A.numRows,B.numRows);

        ImplSparseSparseMult_FSCC.multTransB(A,B,output);
     ...
     */
    public static void multAddTransB(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj output )
    {
        if( A.numCols != B.numCols )
            throw new MatrixDimensionException("Inconsistent matrix shapes. "+stringShapes(A,B));
        ...
        ImplSparseSparseMult_FSCC.multAddTransB(A,B,output);
    }
     ...
     * @param output Dense Matrix
     */
    public static FMatrixRMaj multTransAB(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj output )
    {
        if( A.numRows != B.numCols )
            throw new MatrixDimensionException("Inconsistent matrix shapes. "+stringShapes(A,B));
        output = reshapeOrDeclare(output,A.numCols,B.numRows);

        ImplSparseSparseMult_FSCC.multTransAB(A,B,output);
     ...
     */
    public static void multAddTransAB(FMatrixSparseCSC A , FMatrixRMaj B , FMatrixRMaj output )
    {
        if( A.numRows != B.numCols )
            throw new MatrixDimensionException("Inconsistent matrix shapes. "+stringShapes(A,B));
        ...
        ImplSparseSparseMult_FSCC.multAddTransAB(A,B,output);
    }
...
//        out.nz_length = 0;
     ...
     */
    public static FMatrixSparseCSC apply(FMatrixSparseCSC input, FUnaryOperator func, FMatrixSparseCSC output) {
        if (output == null) {
    ...
    public static FMatrixSparseCSC apply(FMatrixSparseCSC input, FUnaryOperator func) {
     ...
     */
    public static float reduceScalar(FMatrixSparseCSC input, float initValue, FBinaryOperator func) {
    ...
    public static float reduceScalar(FMatrixSparseCSC input, FBinaryOperator func) {
     ...
     */
    public static FMatrixRMaj reduceColumnWise(FMatrixSparseCSC input, float initValue, FBinaryOperator func, FMatrixRMaj output) {
        if (output == null) {
            output = new FMatrixRMaj(1, input.numCols);
        } else {
            output.reshape(1, input.numCols);
     ...
     */
    public static FMatrixRMaj reduceRowWise(FMatrixSparseCSC input, float initValue, FBinaryOperator func, FMatrixRMaj output) {
        if (output == null) {
