...
public class BenchmarkMatrixMatrixMult {
    ...
    public static long multLarge( DenseMatrix64F matA , DenseMatrix64F matB ,
                             DenseMatrix64F matResult , int numTrials) {
        long prev = System.currentTimeMillis();
    ...
    public static void main( String args[] ) {
        ...
        int countTall[] = new int[]{2000,1200,500,500,200,200,100,50,10,5};
