 ...
 */
public class BenchmarkMatrixVectorMultWithSemiRings extends BaseBenchmarkMatrixVectorMult {
    ...
    public void matrixVector() {
        MatrixVectorMultWithSemiRing_DSCC.mult(matrix, inputVector, 0, output, 0, semiRings.get(semiRing));
    }

    @Benchmark
    public void vectorMatrix() {
        MatrixVectorMultWithSemiRing_DSCC.mult(inputVector, 0, matrix, output, 0, semiRings.get(semiRing));
    }
}
