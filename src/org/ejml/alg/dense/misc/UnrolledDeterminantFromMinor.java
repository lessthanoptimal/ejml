...
public class UnrolledDeterminantFromMinor {
    ...
    public static double det2( DenseMatrix64F mat )
    {
        double m[] = mat.data;
    ...
    public static double det3( DenseMatrix64F mat )
    {
        double m[] = mat.data;
    ...
    public static double det4( DenseMatrix64F mat )
    {
    ...
    public static double det5( DenseMatrix64F mat )
    {
        double []data = mat.data;
    ...
    public static double det6( DenseMatrix64F mat )
    {
        double []data = mat.data;
